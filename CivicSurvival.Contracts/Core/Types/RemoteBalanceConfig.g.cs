...
namespace CivicSurvival.Core.Types
{
    public sealed partial class RemoteBalanceConfig
    {
        ...
        public string Version { get; set; } = "2.43.0";

        public string UpdatedAt { get; set; } = "2026-07-27T00:00:00Z";
        ...
        public DraftExemptionConfig DraftExemption { get; set; } = new();

        public ConstructionKickbackConfig ConstructionKickback { get; set; } = new();
        ...
        public void Validate()
        {
            ...
            Waves.EvacuationDangerGraceSeconds = Math.Max(Waves.EvacuationDangerGraceSeconds, 0.0f);
            Waves.EvacuationPanicRadius = Math.Max(Waves.EvacuationPanicRadius, 0.0f);
            ...
            Waves.MaxThreats = Math.Max(Waves.MaxThreats, 1);
            ...
            Waves.LeakRegulatorStrength = Math.Max(Waves.LeakRegulatorStrength, 0.0f);
            Waves.LeakRegulatorMinMultiplier = Math.Max(Waves.LeakRegulatorMinMultiplier, 0.0f);
            Waves.LeakRegulatorSmoothing = Math.Max(Waves.LeakRegulatorSmoothing, 0);
            ...
            Waves.DensityCoeff = FiniteOr(Waves.DensityCoeff, 1.15f);
            Waves.DensityCoeff = Math.Max(Waves.DensityCoeff, 0.0f);
            Waves.DensityExponent = FiniteOr(Waves.DensityExponent, 0.33f);
            Waves.DensityExponent = Math.Max(Waves.DensityExponent, 0.0f);
            ...
            Attention.WealthyFlightInfectionThreshold = ClampUnitFinite(Attention.WealthyFlightInfectionThreshold, 0.55f);
            Attention.WealthyFlightMaxRatePerDay = FiniteOr(Attention.WealthyFlightMaxRatePerDay, 3.0f);
            Attention.WealthyFlightMaxRatePerDay = Math.Max(Attention.WealthyFlightMaxRatePerDay, 0.0f);
            Economy.InsiderCost = Math.Max(Economy.InsiderCost, 0);
            Intel.IntelUpgradeCostPerLevel = Math.Max(Intel.IntelUpgradeCostPerLevel, 0L);
            ...
            Narrative.QuestKotletaChance = ClampUnitFinite(Narrative.QuestKotletaChance, 0.35f);
            Narrative.QuestKotletaCooldownDays = Math.Max(Narrative.QuestKotletaCooldownDays, 0);
            Narrative.QuestKotletaDeadlineHours = FiniteOr(Narrative.QuestKotletaDeadlineHours, 6.0f);
            Narrative.QuestKotletaDeadlineHours = Math.Max(Narrative.QuestKotletaDeadlineHours, 0.5f);
            Narrative.QuestKotletaRewardTons = FiniteOr(Narrative.QuestKotletaRewardTons, 3.0f);
            Narrative.QuestKotletaRewardTons = Math.Max(Narrative.QuestKotletaRewardTons, 0.0f);
            Narrative.QuestVoiceBluntTarget = Math.Max(Narrative.QuestVoiceBluntTarget, 1);
            Narrative.QuestVoiceRewardTrust = ClampUnitFinite(Narrative.QuestVoiceRewardTrust, 0.15f);
            ...
            ConstructionKickback.ExposurePer100k = FiniteOr(ConstructionKickback.ExposurePer100k, 2.0f);
            ConstructionKickback.ExposurePer100k = Math.Max(ConstructionKickback.ExposurePer100k, 0.0f);
            ConstructionKickback.MinPayoutThreshold = Math.Max(ConstructionKickback.MinPayoutThreshold, 0);
            ...
            Scenario.IntroActivistWindow = FiniteOr(Scenario.IntroActivistWindow, 120.0f);
            Scenario.IntroActivistWindow = Math.Max(Scenario.IntroActivistWindow, 0.0f);
            Scenario.IntroAlertSeconds = Math.Max(Scenario.IntroAlertSeconds, 0.0f);
            ...
            Arena.MinWavesForRanking = Math.Max(Arena.MinWavesForRanking, 1);
            InfrastructureRepair.MunicipalRepairHours = FiniteOr(InfrastructureRepair.MunicipalRepairHours, 8.0f);
            ...
            Cognitive.CompromiseThreshold = ClampUnitFinite(Cognitive.CompromiseThreshold, 0.5f);
            ...
            Cognitive.RaidInfectionRate = FiniteOr(Cognitive.RaidInfectionRate, 0.45f);
            Cognitive.PsyOpsMaxIntensity = ClampUnitFinite(Cognitive.PsyOpsMaxIntensity, 0.8f);
            Cognitive.CognitiveDefenseSignalThreshold = ClampUnitFinite(Cognitive.CognitiveDefenseSignalThreshold, 0.75f);
            Cognitive.ResourceRunCommerceMaxPenalty = ClampUnitFinite(Cognitive.ResourceRunCommerceMaxPenalty, 0.25f);
            Cognitive.ResourceRunConfirmationCap = ClampUnitFinite(Cognitive.ResourceRunConfirmationCap, 0.15f);
            Cognitive.BuckwheatRunMitigation = ClampUnitFinite(Cognitive.BuckwheatRunMitigation, 0.4f);
            Cognitive.BankRunDisloyaltyThreshold = ClampUnitFinite(Cognitive.BankRunDisloyaltyThreshold, 0.4f);
            Cognitive.SickLeaveBaseShare = ClampUnitFinite(Cognitive.SickLeaveBaseShare, 0.25f);
            Cognitive.SickLeaveMaxShare = ClampUnitFinite(Cognitive.SickLeaveMaxShare, 0.5f);
            Cognitive.SickLeaveInfectionThreshold = ClampUnitFinite(Cognitive.SickLeaveInfectionThreshold, 0.25f);
            Cognitive.SickLeaveBaseVulnerability = ClampUnitFinite(Cognitive.SickLeaveBaseVulnerability, 0.2f);
            Mobilization.CriticalRecoveryBand = ClampUnit(Mobilization.CriticalRecoveryBand);
            Mobilization.ManpowerLinearDivisor = FiniteOr(Mobilization.ManpowerLinearDivisor, 10000.0f);
            Mobilization.ManpowerLinearDivisor = Math.Max(Mobilization.ManpowerLinearDivisor, 1.0f);
            Mobilization.DodgerMaxPenalty = ClampUnitFinite(Mobilization.DodgerMaxPenalty, 0.35f);
            Mobilization.DodgerPopulationShare = ClampUnitFinite(Mobilization.DodgerPopulationShare, 0.18f);
            ...
            GridWarfare.DroneLauncherCost = Math.Max(GridWarfare.DroneLauncherCost, 0);
            GridWarfare.BallisticLauncherCost = Math.Max(GridWarfare.BallisticLauncherCost, 0);
            GridWarfare.DroneLauncherCrew = Math.Max(GridWarfare.DroneLauncherCrew, 0);
            GridWarfare.BallisticLauncherCrew = Math.Max(GridWarfare.BallisticLauncherCrew, 0);
            ...
            GridWarfare.MirrorCityKeyContrib = Math.Max(GridWarfare.MirrorCityKeyContrib, 0.0f);
            GridWarfare.MirrorCityRegularContrib = FiniteOr(GridWarfare.MirrorCityRegularContrib, 12.0f);
            GridWarfare.MirrorCityRegularContrib = Math.Max(GridWarfare.MirrorCityRegularContrib, 0.0f);
            GridWarfare.MirrorCityReserveMaxHp = FiniteOr(GridWarfare.MirrorCityReserveMaxHp, 100000.0f);
            GridWarfare.MirrorCityReserveMaxHp = Math.Max(GridWarfare.MirrorCityReserveMaxHp, 1.0f);
            GridWarfare.MirrorCityKeyMaxHp = FiniteOr(GridWarfare.MirrorCityKeyMaxHp, 300.0f);
            GridWarfare.MirrorCityKeyMaxHp = Math.Max(GridWarfare.MirrorCityKeyMaxHp, 1.0f);
            GridWarfare.MirrorCityRegularMaxHp = FiniteOr(GridWarfare.MirrorCityRegularMaxHp, 100.0f);
            GridWarfare.MirrorCityRegularMaxHp = Math.Max(GridWarfare.MirrorCityRegularMaxHp, 1.0f);
            GridWarfare.MirrorCityAaMaxHp = FiniteOr(GridWarfare.MirrorCityAaMaxHp, 150.0f);
            ...
            Waves.LeakRegulatorStrength = NonNegativeFinite(Waves.LeakRegulatorStrength, 3f);
            Waves.LeakRegulatorMinMultiplier = ClampUnit(Waves.LeakRegulatorMinMultiplier);
            Waves.LeakRegulatorSmoothing = Math.Max(Waves.LeakRegulatorSmoothing, 0);
            ...
            if (Waves.PsyAttackMin > Waves.PsyAttackMax)
                (Waves.PsyAttackMin, Waves.PsyAttackMax) = (Waves.PsyAttackMax, Waves.PsyAttackMin);
            ...
            if (GridWarfare.MirrorCityRegularMinPerAxis > GridWarfare.MirrorCityRegularMaxPerAxis)
                (GridWarfare.MirrorCityRegularMinPerAxis, GridWarfare.MirrorCityRegularMaxPerAxis) = (GridWarfare.MirrorCityRegularMaxPerAxis, GridWarfare.MirrorCityRegularMinPerAxis);
            GridWarfare.ObjectiveAxisThreshold = Math.Max(GridWarfare.ObjectiveAxisThreshold, GridWarfare.PressureFloor);
        ...
        public RemoteBalanceConfig Clone()
        {
            var clone = new RemoteBalanceConfig
            {
                ...
                DraftExemption = DraftExemption.Clone(),
                ConstructionKickback = ConstructionKickback.Clone(),
    ...
    public sealed partial class ThreatsConfig
    {
        ...
        public int HospitalBaseCasualties { get; set; } = 80;

        public int SchoolBaseCasualties { get; set; } = 120;
    ...
    public sealed partial class WavesConfig
    {
        ...
        public float AlertMin { get; set; } = 180.0f;

        public float AlertMax { get; set; } = 300.0f;

        public float EvacuationDangerGraceSeconds { get; set; } = 300.0f;

        public float EvacuationPanicRadius { get; set; } = 250.0f;
        ...
        public float PsyAttackMin { get; set; } = 240.0f;

        public float PsyAttackMax { get; set; } = 480.0f;

        public float MaxAttackDuration { get; set; } = 1800.0f;

        public float FrequencyBaseMinutes { get; set; } = 60.0f;

        public float FirstCalmBaseMinutes { get; set; } = 55.0f;

        public float FrequencyMwDivisor { get; set; } = 100.0f;

        public float FrequencyRngMin { get; set; } = 0.85f;

        public float FrequencyRngMax { get; set; } = 1.15f;
        ...
        public int MaxThreats { get; set; } = 55;

        public float MinCalmSeconds { get; set; } = 2400.0f;
        ...
        public float MaxWaveInterceptFraction { get; set; } = 0.82f;

        public float LeakRegulatorStrength { get; set; } = 3.0f;

        public float LeakRegulatorMinMultiplier { get; set; } = 0.2f;

        public int LeakRegulatorSmoothing { get; set; } = 6;
        ...
        public float DensityCoeff { get; set; } = 1.15f;

        public float DensityExponent { get; set; } = 0.33f;
        ...
        public WavesConfig Clone()
        {
            var clone = new WavesConfig
            {
                ...
                AlertMin = AlertMin,
                AlertMax = AlertMax,
                EvacuationDangerGraceSeconds = EvacuationDangerGraceSeconds,
                EvacuationPanicRadius = EvacuationPanicRadius,
                AttackMin = AttackMin,
                AttackMax = AttackMax,
                RecoveryMin = RecoveryMin,
                RecoveryMax = RecoveryMax,
                PsyAttackMin = PsyAttackMin,
                PsyAttackMax = PsyAttackMax,
                ...
                LeakRegulatorStrength = LeakRegulatorStrength,
                LeakRegulatorMinMultiplier = LeakRegulatorMinMultiplier,
                LeakRegulatorSmoothing = LeakRegulatorSmoothing,
    ...
    public sealed partial class DiplomacyConfig
    {
        ...
        public float ShockAttentionThreshold { get; set; } = 40.0f;

        public float GlobalShockCooldownMultiplier { get; set; } = 0.5f;
        ...
        public DiplomacyConfig Clone()
        {
            var clone = new DiplomacyConfig
            {
                ...
                ShockAttentionThreshold = ShockAttentionThreshold,
                GlobalShockCooldownMultiplier = GlobalShockCooldownMultiplier,
            };
            return clone;
        }
    }
    ...
    public sealed partial class AttentionConfig
    {
        ...
        public float ShockPerCasualty { get; set; } = 0.1f;

        public float ShockPerBuilding { get; set; } = 0.5f;

        public float ShockMassCasualtyBonus { get; set; } = 1.0f;

        public float ShockCriticalHitBonus { get; set; } = 2.0f;

        public float ShockFirstStrike { get; set; } = 8.0f;
        ...
        public float ExodusHeadlines { get; set; } = 0.25f;

        public float ExodusGlobalMin { get; set; } = 1.0f;

        public float ExodusGlobalMax { get; set; } = 2.0f;

        public int ExodusMilestoneInterval { get; set; } = 50;

        public int ExodusMilestoneMinThreshold { get; set; } = 100;

        public float PsyExodusInfectionThreshold { get; set; } = 0.5f;

        public float PsyExodusMaxRatePerDay { get; set; } = 4.0f;

        public float WealthyFlightInfectionThreshold { get; set; } = 0.55f;

        public float WealthyFlightMaxRatePerDay { get; set; } = 3.0f;

        public int MonacoMilestoneFamilies { get; set; } = 10;
        ...
        public AttentionConfig Clone()
        {
            var clone = new AttentionConfig
            {
                ...
                ShockFirstStrike = ShockFirstStrike,
                ...
                PsyExodusInfectionThreshold = PsyExodusInfectionThreshold,
                PsyExodusMaxRatePerDay = PsyExodusMaxRatePerDay,
                WealthyFlightInfectionThreshold = WealthyFlightInfectionThreshold,
                WealthyFlightMaxRatePerDay = WealthyFlightMaxRatePerDay,
                MonacoMilestoneFamilies = MonacoMilestoneFamilies,
    ...
    public sealed partial class EconomyConfig
    {
        ...
        public int HawkResupplyCost { get; set; } = 30000;

        public float HawkResupplyCooldownHours { get; set; } = 0.0f;

        public int HawkResupplyCooldownWaves { get; set; } = 1;
        ...
        public EconomyConfig Clone()
        {
            var clone = new EconomyConfig
            {
                ...
                HawkResupplyCost = HawkResupplyCost,
                HawkResupplyCooldownHours = HawkResupplyCooldownHours,
                HawkResupplyCooldownWaves = HawkResupplyCooldownWaves,
    ...
    public sealed partial class PowerGridConfig
    {
        ...
        public int SurplusThreshold { get; set; } = 50000;
    ...
    public sealed partial class NarrativeConfig
    {
        ...
        public float QuestKotletaChance { get; set; } = 0.35f;

        public int QuestKotletaCooldownDays { get; set; } = 3;

        public float QuestKotletaDeadlineHours { get; set; } = 6.0f;

        public float QuestKotletaRewardTons { get; set; } = 3.0f;

        public int QuestVoiceBluntTarget { get; set; } = 3;

        public float QuestVoiceRewardTrust { get; set; } = 0.15f;
        ...
        public NarrativeConfig Clone()
        {
            var clone = new NarrativeConfig
            {
                ...
                QuestKotletaChance = QuestKotletaChance,
                QuestKotletaCooldownDays = QuestKotletaCooldownDays,
                QuestKotletaDeadlineHours = QuestKotletaDeadlineHours,
                QuestKotletaRewardTons = QuestKotletaRewardTons,
                QuestVoiceBluntTarget = QuestVoiceBluntTarget,
                QuestVoiceRewardTrust = QuestVoiceRewardTrust,
    ...
    public sealed partial class DraftExemptionConfig
    {
        public float RateIncomePerPercentDay { get; set; } = 600.0f;

        public float RateCorruptionPerPercent { get; set; } = 0.4f;

        public float RateManpowerFractionPerPercent { get; set; } = 0.01f;

        public float OfferChancePerDay { get; set; } = 0.03f;

        public int OfferCashMin { get; set; } = 150000;

        public int OfferCashMax { get; set; } = 500000;

        public int OfferDisabilityHeads { get; set; } = 5;

        public float OfferCorruptionJump { get; set; } = 8.0f;


        public DraftExemptionConfig Clone()
        {
            var clone = new DraftExemptionConfig
            {
                RateIncomePerPercentDay = RateIncomePerPercentDay,
                RateCorruptionPerPercent = RateCorruptionPerPercent,
                RateManpowerFractionPerPercent = RateManpowerFractionPerPercent,
                OfferChancePerDay = OfferChancePerDay,
                OfferCashMin = OfferCashMin,
                OfferCashMax = OfferCashMax,
                OfferDisabilityHeads = OfferDisabilityHeads,
                OfferCorruptionJump = OfferCorruptionJump,
            };
            return clone;
        }
    }

    public sealed partial class ConstructionKickbackConfig
    {
        public float ExposurePer100k { get; set; } = 2.0f;

        public int MinPayoutThreshold { get; set; } = 500;


        public ConstructionKickbackConfig Clone()
        {
            var clone = new ConstructionKickbackConfig
            {
                ExposurePer100k = ExposurePer100k,
    ...
    public sealed partial class ScenarioConfig
    {
        ...
        public float ExodusMultiplierVillage { get; set; } = 0.25f;

        public float ExodusMultiplierTown { get; set; } = 0.5f;

        public float ExodusMultiplierCity { get; set; } = 0.75f;
        ...
        public float IntroActivistWindow { get; set; } = 120.0f;

        public float IntroAlertSeconds { get; set; } = 120.0f;
        ...
        public ScenarioConfig Clone()
        {
            var clone = new ScenarioConfig
            {
                ...
                IntroActivistWindow = IntroActivistWindow,
                IntroAlertSeconds = IntroAlertSeconds,
    ...
    {
        public int MinWavesForRanking { get; set; } = 3;
        ...
        public Dictionary<string, int> ShadowRankThresholds { get; set; } = new()
        {
            ["Aid Skimmer"] = 0,
            ["Disaster Capitalist"] = 5000000,
            ["Fixer"] = 250000,
            ["Fuel Siphoner"] = 50000,
            ["Tender Baron"] = 1000000,
        };

        public Dictionary<string, int> ProsperityRankThresholds { get; set; } = new()
        {
            ["Crisis Manager"] = 1500,
            ["Mayor of the Unbroken City"] = 15000,
            ["People's Mayor"] = 5000,
            ["Ruin Warden"] = 0,
            ["Shelter Keeper"] = 300,
        };
        ...
        {
            var clone = new ArenaConfig
            {
                MinWavesForRanking = MinWavesForRanking,
                RankThresholds = new Dictionary<string, int>(RankThresholds),
                ShadowRankThresholds = new Dictionary<string, int>(ShadowRankThresholds),
                ProsperityRankThresholds = new Dictionary<string, int>(ProsperityRankThresholds),
            };
            return clone;
        }
    }
    ...
    {
        public float MunicipalRepairHours { get; set; } = 8.0f;
    ...
    public sealed partial class CognitiveConfig
    {
        ...
        public float EnemyExposureFloor { get; set; } = 0.15f;
        ...
        public float ImpactInfectionWeight { get; set; } = 0.5f;

        public float RaidInfectionRate { get; set; } = 0.45f;

        public float PsyOpsIntensityPerWave { get; set; } = 0.05f;

        public float PsyOpsMaxIntensity { get; set; } = 0.8f;

        public float PsyOpsInFlightHours { get; set; } = 2.0f;

        public float PropagandaIntensityBase { get; set; } = 0.18f;

        public float PropagandaDurationHours { get; set; } = 4.0f;

        public float RumorIntensityBase { get; set; } = 0.3f;

        public float RumorDurationHours { get; set; } = 4.0f;

        public float RumorSpreadWindowHours { get; set; } = 1.5f;

        public float FakeVideoIntensityBase { get; set; } = 0.8f;

        public float FakeVideoDecayHours { get; set; } = 1.5f;

        public float FakeVideoTrustHit { get; set; } = 0.15f;

        public float VulnMultPoor { get; set; } = 1.2f;

        public float VulnMultMiddle { get; set; } = 1.0f;

        public float VulnMultWealthy { get; set; } = 0.8f;

        public float HeroCounterStrong { get; set; } = 0.7f;

        public float HeroCounterFloor { get; set; } = 0.15f;

        public float PatriotResistanceBonus { get; set; } = 0.2f;

        public float TelemarathonStratumStrong { get; set; } = 0.65f;

        public float TelemarathonStratumFloor { get; set; } = 0.3f;

        public float PatriotWealthyBackfire { get; set; } = -0.3f;

        public float PatriotPoorPress { get; set; } = -0.1f;

        public float BuckwheatStratumPoor { get; set; } = 0.6f;

        public float BuckwheatStratumFloor { get; set; } = 0.2f;

        public float BuckwheatWealthyBackfire { get; set; } = -0.4f;

        public float ArestovychDebtRatePerHour { get; set; } = 0.02f;

        public float ArestovychDebtMax { get; set; } = 1.0f;

        public float ArestovychCollapseBaseHours { get; set; } = 6.0f;

        public float ArestovychCollapseDebtScale { get; set; } = 1.0f;

        public float ArestovychCollapseCooldownHours { get; set; } = 24.0f;

        public int ArchetypeSwitchCost { get; set; } = 20000;

        public float ArchetypeSwitchCooldownHours { get; set; } = 12.0f;

        public float PatriotExodusMultiplier { get; set; } = 1.4f;

        public float RaidSecondaryIntensityMult { get; set; } = 0.5f;

        public int PropagandaCenterCost { get; set; } = 150000;

        public int PropagandaCenterUpgradeCost { get; set; } = 80000;

        public int PropagandaCenterMaxTier { get; set; } = 4;

        public float BroadcastCapacityBase { get; set; } = 1.0f;

        public float BroadcastCapacityPerTier { get; set; } = 1.0f;

        public float BroadcastToolCost { get; set; } = 1.0f;

        public float CoverageCapacityBaseHouseholds { get; set; } = 8000.0f;

        public float CoverageCapacityPerTierHouseholds { get; set; } = 6000.0f;

        public float CenterReachBase { get; set; } = 1.0f;

        public float TelecomReachFloor { get; set; } = 0.2f;

        public float TelecomSignalThreshold { get; set; } = 0.15f;

        public float CognitiveDefenseSignalThreshold { get; set; } = 0.75f;

        public float TelecomRumorSpreadThreshold { get; set; } = 0.25f;

        public float FirewallCapacityDrain { get; set; } = 0.5f;

        public float ResourceRunIntensity { get; set; } = 0.5f;

        public float ResourceRunMaxIntensity { get; set; } = 0.8f;

        public float ResourceRunSpreadMult { get; set; } = 1.5f;

        public float ResourceRunDemandScale { get; set; } = 1.0f;

        public float ResourceRunCommerceWeight { get; set; } = 0.3f;

        public float ResourceRunCommerceMaxPenalty { get; set; } = 0.25f;

        public float ResourceRunConfirmationWeight { get; set; } = 0.25f;

        public float ResourceRunConfirmationCap { get; set; } = 0.15f;

        public float BuckwheatRunMitigation { get; set; } = 0.4f;

        public int BankRunBudgetDrainPerCycle { get; set; } = 15000;

        public float BankRunIntervalHours { get; set; } = 12.0f;

        public float BankRunDisloyaltyThreshold { get; set; } = 0.4f;

        public float SickLeaveBaseShare { get; set; } = 0.25f;

        public float SickLeaveMaxShare { get; set; } = 0.5f;

        public float SickLeaveDurationHours { get; set; } = 10.0f;

        public float SickLeaveInfectionThreshold { get; set; } = 0.25f;

        public float SickLeaveBaseVulnerability { get; set; } = 0.2f;

        public float SickLeaveConscriptionFearMult { get; set; } = 1.5f;
        ...
        public CognitiveConfig Clone()
        {
            var clone = new CognitiveConfig
            {
                ...
                EnemyExposureFloor = EnemyExposureFloor,
                ...
                ImpactInfectionWeight = ImpactInfectionWeight,
                RaidInfectionRate = RaidInfectionRate,
                PsyOpsIntensityPerWave = PsyOpsIntensityPerWave,
                PsyOpsMaxIntensity = PsyOpsMaxIntensity,
                PsyOpsInFlightHours = PsyOpsInFlightHours,
                PropagandaIntensityBase = PropagandaIntensityBase,
                PropagandaDurationHours = PropagandaDurationHours,
                RumorIntensityBase = RumorIntensityBase,
                RumorDurationHours = RumorDurationHours,
                RumorSpreadWindowHours = RumorSpreadWindowHours,
                FakeVideoIntensityBase = FakeVideoIntensityBase,
                FakeVideoDecayHours = FakeVideoDecayHours,
                FakeVideoTrustHit = FakeVideoTrustHit,
                VulnMultPoor = VulnMultPoor,
                VulnMultMiddle = VulnMultMiddle,
                VulnMultWealthy = VulnMultWealthy,
                HeroCounterStrong = HeroCounterStrong,
                HeroCounterFloor = HeroCounterFloor,
                PatriotResistanceBonus = PatriotResistanceBonus,
                TelemarathonStratumStrong = TelemarathonStratumStrong,
                TelemarathonStratumFloor = TelemarathonStratumFloor,
                PatriotWealthyBackfire = PatriotWealthyBackfire,
                PatriotPoorPress = PatriotPoorPress,
                BuckwheatStratumPoor = BuckwheatStratumPoor,
                BuckwheatStratumFloor = BuckwheatStratumFloor,
                BuckwheatWealthyBackfire = BuckwheatWealthyBackfire,
                ArestovychDebtRatePerHour = ArestovychDebtRatePerHour,
                ArestovychDebtMax = ArestovychDebtMax,
                ArestovychCollapseBaseHours = ArestovychCollapseBaseHours,
                ArestovychCollapseDebtScale = ArestovychCollapseDebtScale,
                ArestovychCollapseCooldownHours = ArestovychCollapseCooldownHours,
                ArchetypeSwitchCost = ArchetypeSwitchCost,
                ArchetypeSwitchCooldownHours = ArchetypeSwitchCooldownHours,
                PatriotExodusMultiplier = PatriotExodusMultiplier,
                RaidSecondaryIntensityMult = RaidSecondaryIntensityMult,
                PropagandaCenterCost = PropagandaCenterCost,
                PropagandaCenterUpgradeCost = PropagandaCenterUpgradeCost,
                PropagandaCenterMaxTier = PropagandaCenterMaxTier,
                BroadcastCapacityBase = BroadcastCapacityBase,
                BroadcastCapacityPerTier = BroadcastCapacityPerTier,
                BroadcastToolCost = BroadcastToolCost,
                CoverageCapacityBaseHouseholds = CoverageCapacityBaseHouseholds,
                CoverageCapacityPerTierHouseholds = CoverageCapacityPerTierHouseholds,
                CenterReachBase = CenterReachBase,
                TelecomReachFloor = TelecomReachFloor,
                TelecomSignalThreshold = TelecomSignalThreshold,
                CognitiveDefenseSignalThreshold = CognitiveDefenseSignalThreshold,
                TelecomRumorSpreadThreshold = TelecomRumorSpreadThreshold,
                FirewallCapacityDrain = FirewallCapacityDrain,
                ResourceRunIntensity = ResourceRunIntensity,
                ResourceRunMaxIntensity = ResourceRunMaxIntensity,
                ResourceRunSpreadMult = ResourceRunSpreadMult,
                ResourceRunDemandScale = ResourceRunDemandScale,
                ResourceRunCommerceWeight = ResourceRunCommerceWeight,
                ResourceRunCommerceMaxPenalty = ResourceRunCommerceMaxPenalty,
                ResourceRunConfirmationWeight = ResourceRunConfirmationWeight,
                ResourceRunConfirmationCap = ResourceRunConfirmationCap,
                BuckwheatRunMitigation = BuckwheatRunMitigation,
                BankRunBudgetDrainPerCycle = BankRunBudgetDrainPerCycle,
                BankRunIntervalHours = BankRunIntervalHours,
                BankRunDisloyaltyThreshold = BankRunDisloyaltyThreshold,
                SickLeaveBaseShare = SickLeaveBaseShare,
                SickLeaveMaxShare = SickLeaveMaxShare,
                SickLeaveDurationHours = SickLeaveDurationHours,
                SickLeaveInfectionThreshold = SickLeaveInfectionThreshold,
                SickLeaveBaseVulnerability = SickLeaveBaseVulnerability,
                SickLeaveConscriptionFearMult = SickLeaveConscriptionFearMult,
            };
            return clone;
        }
    }
    ...
    public sealed partial class MobilizationConfig
    {
        ...
        public float CriticalRecoveryBand { get; set; } = 0.05f;

        public float ManpowerCoeff { get; set; } = 1.3f;

        public float ManpowerExponent { get; set; } = 0.33f;

        public float ManpowerLinearDivisor { get; set; } = 10000.0f;
        ...
        public float DodgerAccumPerHour { get; set; } = 0.35f;

        public float DodgerDecayPerHour { get; set; } = 0.05f;

        public float DodgerConscriptionFearMult { get; set; } = 1.5f;

        public float DodgerMaxPenalty { get; set; } = 0.35f;

        public float DodgerPopulationShare { get; set; } = 0.18f;
        ...
        public MobilizationConfig Clone()
        {
            var clone = new MobilizationConfig
            {
                ...
                CriticalThreshold = CriticalThreshold,
                CriticalRecoveryBand = CriticalRecoveryBand,
                ManpowerCoeff = ManpowerCoeff,
                ManpowerExponent = ManpowerExponent,
                ManpowerLinearDivisor = ManpowerLinearDivisor,
                ...
                DodgerAccumPerHour = DodgerAccumPerHour,
                DodgerDecayPerHour = DodgerDecayPerHour,
                DodgerConscriptionFearMult = DodgerConscriptionFearMult,
                DodgerMaxPenalty = DodgerMaxPenalty,
                DodgerPopulationShare = DodgerPopulationShare,
            };
            return clone;
        }
    }
    ...
    public sealed partial class AAUnitsConfig
    {
        ...
        public int HeritageMaxAmmo { get; set; } = 480;
        ...
        public int BoforsMaxAmmo { get; set; } = 1440;
        ...
        public int GepardMaxAmmo { get; set; } = 1920;
        ...
        public int PatriotMaxAmmo { get; set; } = 5;
        ...
        public float HawkRange { get; set; } = 2000.0f;

        public float HawkInterceptShahed { get; set; } = 0.55f;

        public float HawkInterceptBallistic { get; set; } = 0.0f;

        public int HawkMaxAmmo { get; set; } = 7;

        public int HawkBurstRounds { get; set; } = 1;

        public float HawkCooldown { get; set; } = 5.0f;
        ...
        public int HawkPrice { get; set; } = 55000;

        public int PatriotPrice { get; set; } = 100000;

        public float BlackMarketRangeBonus { get; set; } = 0.2f;

        public float BlackMarketInterceptBonus { get; set; } = 0.15f;

        public float BlackMarketPriceMult { get; set; } = 4.0f;
        ...
        public AAUnitsConfig Clone()
        {
            var clone = new AAUnitsConfig
            {
                ...
                HawkRange = HawkRange,
                HawkInterceptShahed = HawkInterceptShahed,
                HawkInterceptBallistic = HawkInterceptBallistic,
                HawkMaxAmmo = HawkMaxAmmo,
                HawkBurstRounds = HawkBurstRounds,
                HawkCooldown = HawkCooldown,
                ...
                BlackMarketRangeBonus = BlackMarketRangeBonus,
                BlackMarketInterceptBonus = BlackMarketInterceptBonus,
                BlackMarketPriceMult = BlackMarketPriceMult,
    ...
    public sealed partial class GridWarfareConfig
    {
        ...
        public int DroneLauncherCost { get; set; } = 25000;

        public int BallisticLauncherCost { get; set; } = 60000;

        public int DroneLauncherCrew { get; set; } = 2;

        public int BallisticLauncherCrew { get; set; } = 4;
        ...
        public float MirrorCityRepairRatePerHour { get; set; } = 8.0f;

        public float MirrorCityRebuildRatePerHour { get; set; } = 0.05f;

        public float MirrorCityConstructionHpFraction { get; set; } = 0.5f;

        public float MirrorCityRebuildDelayHours { get; set; } = 6.0f;

        public float MirrorCityHpDamagePerAxisPoint { get; set; } = 10.0f;

        public float MirrorCityPerAaSiteInterceptChance { get; set; } = 0.25f;

        public float MirrorCityDroneInterceptMultiplier { get; set; } = 1.0f;

        public float MirrorCityKeyTargetCapCutFraction { get; set; } = 0.12f;

        public float MirrorCityReserveContrib { get; set; } = 8.0f;

        public float MirrorCityKeyContrib { get; set; } = 30.0f;

        public float MirrorCityRegularContrib { get; set; } = 12.0f;

        public float MirrorCityReserveMaxHp { get; set; } = 100000.0f;

        public float MirrorCityKeyMaxHp { get; set; } = 300.0f;

        public float MirrorCityRegularMaxHp { get; set; } = 100.0f;

        public float MirrorCityAaMaxHp { get; set; } = 150.0f;

        public float MirrorCityAaRange { get; set; } = 2500.0f;

        public int MirrorCityRegularMinPerAxis { get; set; } = 2;

        public int MirrorCityRegularMaxPerAxis { get; set; } = 4;

        public int MirrorCityAaSiteCount { get; set; } = 3;
        ...
        public GridWarfareConfig Clone()
        {
            var clone = new GridWarfareConfig
            {
                ...
                DroneLauncherCost = DroneLauncherCost,
                BallisticLauncherCost = BallisticLauncherCost,
                DroneLauncherCrew = DroneLauncherCrew,
                BallisticLauncherCrew = BallisticLauncherCrew,
                ...
                MirrorCityRepairRatePerHour = MirrorCityRepairRatePerHour,
                MirrorCityRebuildRatePerHour = MirrorCityRebuildRatePerHour,
                MirrorCityConstructionHpFraction = MirrorCityConstructionHpFraction,
                MirrorCityRebuildDelayHours = MirrorCityRebuildDelayHours,
                MirrorCityHpDamagePerAxisPoint = MirrorCityHpDamagePerAxisPoint,
                MirrorCityPerAaSiteInterceptChance = MirrorCityPerAaSiteInterceptChance,
                MirrorCityDroneInterceptMultiplier = MirrorCityDroneInterceptMultiplier,
                MirrorCityKeyTargetCapCutFraction = MirrorCityKeyTargetCapCutFraction,
                MirrorCityReserveContrib = MirrorCityReserveContrib,
                MirrorCityKeyContrib = MirrorCityKeyContrib,
                MirrorCityRegularContrib = MirrorCityRegularContrib,
                MirrorCityReserveMaxHp = MirrorCityReserveMaxHp,
                MirrorCityKeyMaxHp = MirrorCityKeyMaxHp,
                MirrorCityRegularMaxHp = MirrorCityRegularMaxHp,
                MirrorCityAaMaxHp = MirrorCityAaMaxHp,
                MirrorCityAaRange = MirrorCityAaRange,
                MirrorCityRegularMinPerAxis = MirrorCityRegularMinPerAxis,
                MirrorCityRegularMaxPerAxis = MirrorCityRegularMaxPerAxis,
                MirrorCityAaSiteCount = MirrorCityAaSiteCount,
            };
            return clone;
        }
    }
...
namespace CivicSurvival.Core.Infrastructure
{
    ...
    {
        public int CurrentWave { get; set; } = 4;
