...
namespace CivicSurvival.Services.Arena
{
    public static class ArenaWireWriter
    {
        ...
        public static string BuildLeaderboardEntryJson(LeaderboardEntry dto)
        {
            ...
            sb.Append(',');
            WriteName(sb, "WavesSurvived");
            sb.Append(dto.WavesSurvived.ToString(CultureInfo.InvariantCulture));
            sb.Append(',');
            WriteName(sb, "Intercepted");
            sb.Append(dto.Intercepted.ToString(CultureInfo.InvariantCulture));
            sb.Append(',');
            WriteName(sb, "Score");
            sb.Append(dto.Score.ToString(CultureInfo.InvariantCulture));
            sb.Append(',');
            WriteName(sb, "SuccessRate");
            sb.Append(dto.SuccessRate.ToString("R", CultureInfo.InvariantCulture));
            sb.Append(',');
        ...
        public static string BuildShadowLeaderboardEntryJson(ShadowLeaderboardEntry dto)
        {
            var sb = new StringBuilder(INITIAL_CAPACITY);
            sb.Append('{');
            WriteName(sb, "Position");
            ...
            sb.Append(',');
            WriteName(sb, "Earned");
            sb.Append(dto.Earned.ToString(CultureInfo.InvariantCulture));
            sb.Append(',');
            WriteName(sb, "Confiscated");
            sb.Append(dto.Confiscated.ToString(CultureInfo.InvariantCulture));
            sb.Append(',');
            WriteName(sb, "Net");
            sb.Append(dto.Net.ToString(CultureInfo.InvariantCulture));
            sb.Append(',');
            WriteName(sb, "RankTier");
            WriteString(sb, dto.RankTier);
            sb.Append('}');
        ...
        public static string BuildWeeklyShadowLeaderboardEntryJson(WeeklyShadowLeaderboardEntry dto)
        {
            var sb = new StringBuilder(INITIAL_CAPACITY);
            sb.Append('{');
            WriteName(sb, "Position");
        ...
        public static string BuildShadowStatsJson(ShadowStats dto)
        {
            var sb = new StringBuilder(INITIAL_CAPACITY);
            sb.Append('{');
            WriteName(sb, "Earned");
        ...
        public static string BuildProsperityLeaderboardEntryJson(ProsperityLeaderboardEntry dto)
        {
            var sb = new StringBuilder(INITIAL_CAPACITY);
            sb.Append('{');
            WriteName(sb, "Position");
            ...
            sb.Append(',');
            WriteName(sb, "Waves");
            sb.Append(dto.Waves.ToString(CultureInfo.InvariantCulture));
            sb.Append(',');
            WriteName(sb, "AvgIndex");
            sb.Append(dto.AvgIndex.ToString(CultureInfo.InvariantCulture));
            sb.Append(',');
            WriteName(sb, "Score");
            sb.Append(dto.Score.ToString(CultureInfo.InvariantCulture));
            sb.Append(',');
        ...
        public static string BuildWeeklyProsperityLeaderboardEntryJson(WeeklyProsperityLeaderboardEntry dto)
        {
            var sb = new StringBuilder(INITIAL_CAPACITY);
            sb.Append('{');
            WriteName(sb, "Position");
        ...
        public static string BuildProsperityStatsJson(ProsperityStats dto)
        {
            var sb = new StringBuilder(INITIAL_CAPACITY);
            sb.Append('{');
            WriteName(sb, "Waves");
