...
namespace CivicSurvival.Core.Services
{
    ...
    public static class BudgetSource
    {
        ...
        public const string CenterInstallRefund = "CenterInstallRefund";
        public const string DroneLauncherInstallRefund = "DroneLauncherInstallRefund";
        public const string BallisticLauncherInstallRefund = "BallisticLauncherInstallRefund";
    ...
    public static class CityBudgetService
    {
        ...
        public static BudgetIncomeKind ClassifyIncomeSource(string? source)
        {
            ...
            if (source == BudgetSource.ResupplyRefund
                ...
                || source == BudgetSource.CenterInstallRefund
                || source == BudgetSource.DroneLauncherInstallRefund
                || source == BudgetSource.BallisticLauncherInstallRefund
