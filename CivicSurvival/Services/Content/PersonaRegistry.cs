...
#pragma warning restore CIVIC148
        ...
        private static void RegisterBuiltInPersonas()
        {
            ...
            s_Personas["DSNS"] = new[]
            {
                new PersonaProfile("DSNS", "@RescueService_Official", "NEWS_DSNS")
            };
            ...
            {
                new PersonaProfile("NATO_SUPPORT", "@Coalition_Support", "NEWS_NATO_SUPPORT")
            };

            s_Personas["NATO_DEFENSE"] = new[]
            {
                new PersonaProfile("NATO_DEFENSE", "@Coalition_Defense", "NEWS_NATO_DEFENSE")
            };
            ...
            {
                new PersonaProfile("TRO_COMMANDER", "@TerritorialDefense", "NEWS_TRO")
            };
            ...
            {
                new PersonaProfile("NEXTA", "@FreePress_Live", "NEWS_NEXTA")
            };

            s_Personas["PRIVATBANK"] = new[]
            {
                new PersonaProfile("PRIVATBANK", "@CityBank", "NEWS_LOCAL")
            };
            ...
            {
                new PersonaProfile("ZELENSKYY", "@President_Official", "NEWS_MILITARY")
            };
            ...
            s_Personas["REFUGEE"] = new[]
            {
                ...
                new PersonaProfile("REFUGEE_3", "@evacuee_city", "CHIRP_REFUGEE")
            };
            ...
            s_Personas["LOCAL_RESIDENT"] = new[]
            {
                ...
                new PersonaProfile("LOCAL_RESIDENT_2", "@city_citizen", "CHIRP_RESIDENT"),
