...
#pragma warning disable CIVIC135 // Debug sub-keys are string-based by design
            return key switch
            {
                ...
                // Cognitive-domain cost attribution (FPS investigation 2026-07-22): isolate the
                // MHR resolve chain / stats aggregator from the other ~20 domain systems.
                "mhr"        => world.GetExistingSystemManaged<MentalHealthResolverSystem>(),
                "cogStats"   => world.GetExistingSystemManaged<CognitiveStatsAggregatorSystem>(),
                _ => null
            };
#pragma warning restore CIVIC135
        }
        ...
        private static readonly SnapshotEntry[] s_SnapshotEntries =
        {
            ...
            new("mhr", "sub", "d:cognitive"),
            new("cogStats", "sub", "d:cognitive"),
        };
