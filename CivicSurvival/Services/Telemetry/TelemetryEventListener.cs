...
{
    /// <summary>
    /// Composite EventBus subscriber for telemetry. Owns eight domain-specific
    /// sub-listeners (Threat, Manpower, Cognitive, Corruption, Diplomacy, Attention, GameLoop, Request)
    ...
    public sealed class TelemetryEventListener : IDisposable
    {
        ...
        private readonly AttentionTelemetryListener m_Attention;
            ...
            string sessionId)
        {
            ...
            m_Attention = new AttentionTelemetryListener(eventBus, recorder, sessionId);
