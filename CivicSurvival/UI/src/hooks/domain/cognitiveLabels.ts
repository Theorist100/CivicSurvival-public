...
// Speaker archetype (Phase 04) — mirrors C# HeroArchetype enum.
export const HeroArchetype = {
    Voice: 0,
    Arestovych: 1,
    Patriot: 2,
} as const;
...
export type HeroArchetypeType = typeof HeroArchetype[keyof typeof HeroArchetype];
