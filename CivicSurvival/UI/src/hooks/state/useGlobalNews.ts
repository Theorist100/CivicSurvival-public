...
export interface GlobalNewsState {
    ...
    /** Whether the nickname can be edited (server-side value — needs Online) */
    canEditNickname: boolean;
    /** Why nickname editing is locked; empty when editable */
...
function toGlobalNewsState(dto: NewsDto): GlobalNewsState {
    return {
        ...
        canEditNickname: dto.CanEditNickname ?? false,
        nicknameLockedReasonId: dto.NicknameLockedReasonId ?? "",
