...
export const techNoirTheme: Theme = {
    ...
    typography: {
        ...
        // The only shipped monospace (Perfect DOS VGA 437) is a pixel font that
        // reads poorly — the mono SLOT stays (swap point for a future custom
        // font), but it resolves to the clean shipped sans.
        fontFamilyMono: "'Noto Sans', Overpass, sans-serif",
