...
export const setDraftDeferralPercent = (percent: PercentValue): void =>
    triggerCivic(B.SetDraftDeferralPercent, percent);

export const setConstructionKickbackPercent = (percent: PercentValue): void =>
    triggerCivic(B.SetConstructionKickbackPercent, percent);
