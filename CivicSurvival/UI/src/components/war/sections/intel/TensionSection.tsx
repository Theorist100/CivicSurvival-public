...
export const TensionSection: React.FC<TensionSectionProps> = memo(({
    ...
    return (
        <div style={s.sectionNavy}>
            {/* Neutral header (navy calm-down 2026-07-22): the status colour stays on the
                value and the bar — a coloured header double-counted the alarm. */}
            <div style={s.sectionTitleColored(WARROOM_NAVY.label)}>
