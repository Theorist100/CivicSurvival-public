...
import { LabeledBar, StatRow } from "../../../../shared/ui";
import { DEFAULT_COGNITIVE_DTO } from "../../../../../types/domainDtos";
import { styles } from "./infoSections.styles";

/** Fits the longest caption of the three stat rows ("Avg Resistance" / "Сер. зараження"). */
const STAT_LABEL_WIDTH = "96rem";
...
export const HouseholdStatsSection: React.FC = () => {
    ...
    return (
        <div style={styles.statusBox(theme)}>
            ...
            {/* Label column is pinned (see LabeledBar): "Avg Resistance" is the longest caption of
                the three, and a content-sized column would start its bar further right than the
                other two. */}
            <Column gap={theme.spacing.xs}>
                <LabeledBar
                    ...
                    labelWidth={STAT_LABEL_WIDTH}
                    valueColor={getBarColorNegative(cw.AvgInfection)}
                />
                ...
                <LabeledBar
                    ...
                    labelWidth={STAT_LABEL_WIDTH}
                    valueColor={getBarColorPositive(cw.AvgResistance)}
                />
                ...
                <LabeledBar
                    ...
                    labelWidth={STAT_LABEL_WIDTH}
                    valueColor={getBarColorNegative(cw.AvgTrauma)}
                />
            </Column>
