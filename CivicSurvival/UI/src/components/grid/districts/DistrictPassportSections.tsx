...
import { PanelSection, SectionHeader, SectionTitle, StatRow } from "../../shared/ui";
...
export const DistrictProtectionSection: React.FC<DistrictProtectionSectionProps> = ({
    ...
    return (
        <PanelSection>
            <SectionHeader
                title={l.t("UI_DP_PROTECTION_NETWORK")}
                help={
                    <HelpSection id="protection" title={l.t("UI_DP_PROTECTION_NETWORK")}>
                        {l.t("HELP_PROTECTION")}
                    </HelpSection>
                }
            />
