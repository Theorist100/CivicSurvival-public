...
import { useTheme, useModalPalette, FONT_STACK_SERIF } from "../../../themes";
        ...
        posts.length === 0 ? (
            ...
            {hasBreaking && (
                <div style={breakingBannerStyle}>
                    {/* The dot is drawn, not typed: the game's font has no ● and printed an empty
                        tofu box in its place. */}
                    <span style={{
                        width: "6rem", height: "6rem", borderRadius: "50%",
                        background: breakingMoodColor, marginRight: "6rem", flexShrink: 0,
                    }} />
