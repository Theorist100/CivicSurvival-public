...
const DebriefingModalView: React.FC = () => {
    ...
    const evacSheltered = threat.DebriefingEvacSheltered;
    const evacEnRoute = threat.DebriefingEvacEnRoute;
            ...
            <div style={base.modal}>
                ...
                <div style={base.body}>
                    ...
                    <StatSection title={l.t("UI_DEBRIEF_IMPACT")}>
                        ...
                        {(evacSheltered > 0 || evacEnRoute > 0) && (
                            <StatRow
                                label={l.t("UI_DEBRIEF_EVAC_SHELTERED")}
                                value={evacSheltered}
                                valueColor={evacSheltered > 0 ? m.success.text : undefined}
                            />
                        )}
                        {evacEnRoute > 0 && (
                            <StatRow
                                label={l.t("UI_DEBRIEF_EVAC_EN_ROUTE")}
                                value={evacEnRoute}
                                valueColor={m.warning.text}
                            />
                        )}
