...
import { ModUpdatedRestartModalDef } from "./ModUpdatedRestartModal";
import { ModUpdatePendingModalDef } from "./ModUpdatePendingModal";
import { DebriefingModalDef } from "./DebriefingModal";
import { PsyDebriefingModalDef } from "./PsyDebriefingModal";
import { PsyRaidInboundModalDef } from "./PsyRaidInboundModal";
...
import { QuestCompletedModalDef, QuestFailedModalDef } from "./QuestResultModal";
...
export const MODAL_REGISTRY: Record<ModalId, ModalDefinition> = {
    ...
    ModUpdatedRestart: ModUpdatedRestartModalDef,
    ModUpdatePending: ModUpdatePendingModalDef,
    Debriefing: DebriefingModalDef,
    PsyDebriefing: PsyDebriefingModalDef,
    PsyRaidInbound: PsyRaidInboundModalDef,
    ...
    // Two ids, one component: the outcome only swaps accent, icon and text keys.
    QuestCompleted: QuestCompletedModalDef,
    QuestFailed: QuestFailedModalDef,
};
