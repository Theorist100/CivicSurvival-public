...
export const WarRoomStrikeCard: React.FC<Props> = memo(({
    ...
    if (!resolved) {
        return (
            <div style={{ ...wrap, alignItems: "center" }}>
                <span style={{ fontSize: "11rem", fontStyle: "italic", color: theme.colors.textMuted }}>
    ...
    return (
        <div style={wrap}>
            ...
            {strikeFallsBack && (
                <span style={{ fontSize: "10rem", fontStyle: "italic", color: theme.colors.textMuted, marginTop: "6rem" }}>
