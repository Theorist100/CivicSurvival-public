...
const createChipStyles = (theme: Theme) => {
    ...
    return {
        ...
        // Navy calm-down (approved mock 2026-07-22): the chip surface is NEUTRAL — the
        // axis colour survives only in the thin health line below. Three full-colour
        // panels next to each other were the loudest block on the tab.
        ...
        // Name and value are neutral; the underscore param keeps call sites uniform
        // while the colour identity lives in the fill line alone.
        axisName: (_color: string): React.CSSProperties => ({
            fontSize: "11rem",
        ...
        value: (_color: string): React.CSSProperties => ({
            fontSize: "15rem",
            fontWeight: theme.typography.weightBold,
            lineHeight: 1,
            color: WARROOM_NAVY.text,
            fontFamily: mono,
        }),
        track: {
            height: "3rem",
                ...
                return (
                    <div key={c.axisKey} style={s.chip(c.color, stretch, i === chips.length - 1)}>
                        ...
                        <div style={s.subRow}>
                            ...
                            <span style={s.confTag(coarse ? WARROOM_NAVY.muted : WARROOM_NAVY.label)}>
