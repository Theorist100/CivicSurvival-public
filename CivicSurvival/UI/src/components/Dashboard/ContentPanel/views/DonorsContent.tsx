...
const DonorsContentReady = memo(({ data }: { data: DonorData }) => {
    ...
    const dialogPending = openDialog.isPending || closeDialog.isPending;
    ...
    return (
        <div style={s.container}>
            ...
            <div style={s.section}>
                ...
                {donor.AvailableViaAttention && (
                    <div style={{ fontSize: theme.typography.sizeXS, color: data.shockColor, marginTop: theme.spacing.xs, fontWeight: 600 }}>
                        {l.t("AID_AVAILABLE_VIA_ATTENTION")}
                    </div>
                )}
            </div>
            ...
            <div style={s.section}>
                ...
                {!donor.DonorDialogActive && data.conferenceLockedReasonKey && (
                    <div style={{ fontSize: theme.typography.sizeXS, color: theme.colors.textSecondary, fontWeight: 600, marginTop: theme.spacing.xs }}>
                        {l.t(data.conferenceLockedReasonKey, donor.DonorCooldownDays)}
                    </div>
                )}
