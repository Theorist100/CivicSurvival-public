        ...
        <Column gap={theme.spacing.sm}>
            ...
            <Row gap={theme.spacing.xs} align="stretch">
                <StatTile
                    ...
                    color={compromised ? accents.crisis.accent : accents.schemes.accent}
                ...
                <HoverTip text={cosintTip} style={{ flex: 1, display: "flex" }}>
                    <button
                        style={{
                            ...
                            width: "100%",
                            background: spotters.CounterOSINTActive ? hexToRgba(accents.schemes.accent, 0.14) : "transparent",
                        }}
