...
import { IconArrowDown, IconChevronRight } from "../../../../shared/common/Icons";
...
export const DestroyedGroup: React.FC<DestroyedGroupProps> = ({ rows }) => {
    ...
    return (
        <div style={{ overflow: "visible" }}>
            ...
            >
                {/* SVG, not the ▾/▸ glyphs: the game's font has no such characters and the row
                    printed an empty tofu box where the twisty should be. */}
                <span style={{ marginRight: "6rem", display: "flex", alignItems: "center", width: "12rem", flexShrink: 0 }}>
                    {expanded ? <IconArrowDown /> : <IconChevronRight />}
                </span>
