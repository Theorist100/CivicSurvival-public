...
export const createWarViewsStyles = (theme: Theme, accents: Accents) => {
    ...
    return {
        ...
        // Navy variant of `section` (calm-down 2026-07-22): the same box on a neutral
        // navy surface — the intel forecast column draws THIS as its only frame (an
        // outer card wrapper double-boxed the column and ate its width).
        sectionNavy: {
            ...base.section,
