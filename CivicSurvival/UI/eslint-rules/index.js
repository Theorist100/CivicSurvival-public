 ...
 *   CIVIC-UI-054  no-file-served-icons            All icon art inlined in the bundle (JSX glyphs / data URIs), never file-served
 *   CIVIC-UI-055  no-italic-font-style            CS2 ships no italic face; synthesized italic drops CJK glyphs
 */
...
module.exports = {
    rules: {
        ...
        "no-file-served-icons": require("./no-file-served-icons"),
        "no-italic-font-style": require("./no-italic-font-style"),
    },
};
