...
export default tseslint.config(
    ...
    // ── React + Civic (Coherent UI rules) ──────────────────────────
    {
        ...
        rules: {
            ...
            "civic/no-file-served-icons": "error",            // CIVIC-UI-054: all icon art inlined in the bundle, never file-served
            "civic/no-italic-font-style": "error",            // CIVIC-UI-055: CS2 ships no italic face; synthesized italic drops CJK glyphs
