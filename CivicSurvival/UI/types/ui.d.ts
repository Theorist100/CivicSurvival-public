declare module "cs2/ui" {
  ...
  export const Tooltip: import("react").MemoExoticComponent<(props: TooltipProps & {
  	children?: ReactNode;
  ...
  export const Dropdown: ({ focusKey, initialFocused, theme: partialTheme, content, alignment, children, onToggle }: PropsWithChildren<DropdownProps>) => JSX.Element;
  ...
  export const DropdownToggle: ({ theme, openIconComponent, closeIconComponent, children, ...props }: PropsWithChildren<DropdownToggleProps>) => JSX.Element;
  ...
  export const Icon: ({ tinted, className, src, children }: IconProps) => JSX.Element;
  ...
  export const FormattedText: ({ focusKey, text, theme: partialTheme, renderer, className, onLinkSelect, selectAction, nonInline, ...props }: FormattedTextProps) => JSX.Element;
  ...
  export const FormattedParagraphs: ({ focusKey, text, theme: partialTheme, renderer, className, children, onLinkSelect, selectAction, nonInline, maxLineLength, splitLineLength, ...props }: PropsWithChildren<FormattedParagraphsProps>) => JSX.Element;
