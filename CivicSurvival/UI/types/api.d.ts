// Coherent / CS2 ambient API declarations copied from the UI modding toolchain.
// Keep this file parseable in isolation before regenerating from vendor sources.
declare module "cs2/api" {
  ...
  /** Subscribe to a ValueBinding. Returns {} before the C# binding is registered. */
  ...
  export function useValueOnChange<V>(binding: ValueBinding<V>, onChange: (value: V, prevValue: V) => void, depth?: number): V;
  export function useMapValueOnChange<K, V>(binding: MapBinding<K, V>, key: K, onChange: (newValue: V) => void): V;
