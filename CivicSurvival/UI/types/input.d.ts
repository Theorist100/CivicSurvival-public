declare module "cs2/input" {
  ...
  export function useMultiChildFocusController(focusKey: UniqueFocusKey | null, activation: FocusActivation, limits: FocusLimits): MultiChildFocusController;
  ...
  export function getClosestKeyInDirection(controller: MultiChildFocusController, focusedElement: FocusController, dir: Number2, anchor: Number2, ignoreKey?: UniqueFocusKey): UniqueFocusKey | null;
   ...
   */
  export const NavigationScope: ({ focusKey, debugName, focused, direction, activation, limits, children, onFocused, onChange, onRefocus, allowFocusExit, allowLooping, jumpSections, }: React$1.PropsWithChildren<NavigationScopeProps>) => JSX.Element;
   ...
   */
  export const AutoNavigationScope: ({ onRefocus, onChange, allowFocusExit, allowLooping, debugName, focusKey, forceFocus, initialFocused, ...props }: React$1.PropsWithChildren<AutoNavigationScopeProps>) => JSX.Element;
   ...
   * Optionally, a `focusKey` for the component itself can be set.
   */
  export const FocusScope: ({ focusKey, debugName, focused, activation, limits, children }: React$1.PropsWithChildren<FocusScopeProps>) => JSX.Element;
  export interface SelectableFocusBoundaryProps {
  	onSelectedStateChanged?: (selected: boolean) => void;
  }
  export const SelectableFocusBoundary: ({ onSelectedStateChanged, children }: React$1.PropsWithChildren<SelectableFocusBoundaryProps>) => JSX.Element;
  ...
  export const InputActionHints: (props: InputActionHintsProps & React$1.RefAttributes<HTMLDivElement>) => React$1.ReactElement<any, string | React$1.JSXElementConstructor<any>> | null;
  ...
  export const InputHint: ({ action, active, controlScheme, ...props }: InputHintProps) => JSX.Element | null;
  export const ActiveControlSchemeInputHint: (props: InputHintProps) => JSX.Element;
  ...
  export const ControlIcons: ({ modifiers, bindings, showName, shortName, theme, className, style, children }: React$1.PropsWithChildren<ControlIconsProps>) => JSX.Element;
  ...
  export const SelectConsumer: ({ action, ...props }: React$1.PropsWithChildren<Partial<SingleActionConsumerProps>>) => JSX.Element;
  /** When the Keyboard "ESC" or Gamepad "B" button is pressed */
  export const BackConsumer: ({ action, ...props }: React$1.PropsWithChildren<Partial<SingleActionConsumerProps>>) => JSX.Element;
  ...
  export function setInputActionPriority(action: InputAction, requestId: string | null, priority: number, force: boolean): void;
  ...
  export function useInputController(state: InputControllerState, transformer: InputStackTransformer | null): InputController;
