// Coherent / CS2 ambient binding declarations copied from the UI modding toolchain.
// Keep this file parseable in isolation before regenerating from vendor sources.
declare module "cs2/bindings" {
  type ChartDataset<TType extends string = string, TData = unknown> = {
  	type?: TType;
  	label?: string;
  	data: TData;
  ...
  export { event$1 as event, toolbar$1 as toolbar };
