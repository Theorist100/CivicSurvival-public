...
namespace CivicSurvival.Domains.Cognitive.Core.Systems
{
    ...
    ///
    /// Serialized: IsActive, InternetMode, CognitiveIntegrityBuffer.
    /// (m_LastInternetMode is NOT persisted — rebuilt in ValidateAfterLoad from restored InternetMode.)
    ...
    public partial class CognitiveStateSystem : IDefaultSerializable, IBootDefaultsReset
    {
        ...
        /// <summary>
        /// Single-source transient reset — decoded-payload holder + boot-restore latch to their quiescent
        /// values. Callers that need the latch armed (ResetToBootDefaults) re-arm it after.
        /// </summary>
        ...
        {
            ClearTransientState();
            m_RestoreBootDefaultsAfterLoad = true; // arm boot-restore; OnLoadRestore performs the structural reset
        ...
        public void Serialize<TWriter>(TWriter writer) where TWriter : IWriter
        {
            ...
            try
            {
                ...
                CognitiveStateCodec.Write(persistState, writer, map);
        ...
        public void Deserialize<TReader>(TReader reader) where TReader : IReader
        {
            ...
            try
            {
                ...
                m_RestoreBootDefaultsAfterLoad = false;
                // m_LastInternetMode is set authoritatively in ValidateAfterLoad (= restored InternetMode);
                // no need to assign it here or persist it separately.
