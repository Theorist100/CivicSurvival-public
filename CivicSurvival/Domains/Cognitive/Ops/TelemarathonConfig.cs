...
namespace CivicSurvival.Domains.Cognitive.Ops
{
    ...
    public struct TelemarathonConfig : IComponentData
    {
        ...
        // FatigueDecayOnSwitch removed: fixed switch decay replaced by recovery proportional
        // to the accumulation pause (FatigueRatePerHour × grace hours since last switch).
    }
}
