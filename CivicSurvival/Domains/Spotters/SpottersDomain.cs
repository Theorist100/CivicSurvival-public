...
namespace CivicSurvival.Domains.Spotters
{
    ...
    public class SpottersDomain : IFeatureModule, IUiFeatureModule
    {
        ...
        public void RegisterSystems(UpdateSystem updateSystem)
        {
            ...
            // Player spotter commands — pause-safe ModificationEnd route (Axiom 14):
            // synchronous payment + same-tick apply on the aggregate's managed state.
            updateSystem.RegisterAt<SpotterCommandIngressSystem>(SystemUpdatePhase.ModificationEnd);
