...
namespace CivicSurvival.Domains.GridWarfare.Data
{
    ...
    public struct OperationSlot
    {
        ...
        /// <summary>
        /// Mirror-city target this operation is aimed at (phase C). Auto-selected at Execute for now
        /// (<see cref="EnemyTarget.NoTargetId"/> = unselected / resolve automatically); the War Room UI
        /// (phase E) will let the player pick it. Persisted so a save/load keeps the selection.
        /// </summary>
        ...
        public static OperationSlot Empty => new()
        {
            ...
            TargetId = EnemyTarget.NoTargetId
        };
    }
}
