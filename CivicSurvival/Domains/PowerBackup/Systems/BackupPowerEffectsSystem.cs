...
namespace CivicSurvival.Domains.PowerBackup.Systems
{
    ...
    public partial class BackupPowerEffectsSystem : ThrottledSystemBase, IActGatedSystem
    {
        ...
        // Per-system m_IgniteQueuedThisFrame
        ...
        protected override void OnCreate()
        {
            ...
            Log.Info($"{nameof(BackupPowerEffectsSystem)} created (active from PreWar)");
        }
        ...
        private void InitializeGate()
        {
            m_Gate = new ActGateController(
                // Backup reserve effects run from PreWar, matching BackupPowerRuntimeSystem.
                isOpenFor: _ => true,
