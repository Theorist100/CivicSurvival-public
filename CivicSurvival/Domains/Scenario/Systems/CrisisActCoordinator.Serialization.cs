    ...
    public partial class CrisisActCoordinator : IDefaultSerializable, IResettable, IBootDefaultsReset
    {
        ...
        public void Serialize<TWriter>(TWriter writer) where TWriter : IWriter
        {
            ...
            try
            {
                var state = new CrisisActCoordinatorPersistState(
                    ...
                    m_PreviousAct,
                    m_BankingChirpSent,
                    m_ExodusPendingSinceDay,
                    m_HasExodusPendingSince);
        ...
        public void Deserialize<TReader>(TReader reader) where TReader : IReader
        {
            ...
            try
            {
                ...
                m_ExodusPendingSinceDay = state.ExodusPendingSinceDay;
                m_HasExodusPendingSince = state.HasExodusPendingSince;
