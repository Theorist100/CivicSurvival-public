...
namespace CivicSurvival.Domains.Scenario.Systems
{
    ...
    public partial class WaveScheduler : IDefaultSerializable, IBootDefaultsReset
    {
        ...
        public void Serialize<TWriter>(TWriter writer) where TWriter : IWriter
        {
            ...
            try
            {
                ...
                var persistState = new WaveSchedulerPersistState(
                    ...
                    state.NextWaveType,
                    state.NextWaveThreatsForecast,
                    state.HasNextWaveForecast,
                    state.RandomState,
        ...
        public void Deserialize<TReader>(TReader reader) where TReader : IReader
        {
            ...
            try
            {
                // Clear runtime transients before applying the payload so the reused instance can't carry
                // launch-window/readiness-gate state from the previous city into the loaded one.
                ClearRuntimeTransients();
...
#pragma warning restore CIVIC144
                ...
                SetSaveState(new SchedulerSaveState(
                    ...
                    persistState.NextWaveType,
                    persistState.NextWaveThreatsForecast,
                    persistState.HasNextWaveForecast,
                    randomState,
