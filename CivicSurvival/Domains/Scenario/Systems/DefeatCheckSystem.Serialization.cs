...
namespace CivicSurvival.Domains.Scenario.Systems
{
    public partial class DefeatCheckSystem : IBootDefaultsReset
    {
        ...
        public void Serialize<TWriter>(TWriter writer) where TWriter : IWriter
        {
            ...
            try
            {
                var state = new DefeatCheckPersistState(m_IntegrityBelowThresholdHours, m_PendingCollapseWarDay);
        ...
        public void Deserialize<TReader>(TReader reader) where TReader : IReader
        {
            ...
            try
            {
                ...
                // A collapse observation waiting for the day boundary survives the save: a
                // player who reloads more often than once per game day would otherwise never
                // reach the verdict. Confirming it after load is safe because the check itself
                // does not run until the resident count reports itself ready.
                m_PendingCollapseWarDay = state.PendingCollapseWarDay;
                ...
                Log.Info($"Deserialized: IntegrityHours={m_IntegrityBelowThresholdHours:F1}, PendingCollapseWarDay={m_PendingCollapseWarDay}");
            }
