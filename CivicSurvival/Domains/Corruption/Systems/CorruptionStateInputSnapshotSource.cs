...
namespace CivicSurvival.Domains.Corruption.Systems
{
    internal readonly struct CorruptionStateInputSnapshot : IEquatable<CorruptionStateInputSnapshot>
    {
        ...
        public CorruptionStateInputSnapshot(
            ...
            bool hasDraftExemption,
            int draftDeferralPercent,
            ...
            int vipBypassCount)
        {
            ...
            HasDraftExemption = hasDraftExemption;
            DraftDeferralPercent = draftDeferralPercent;
        ...
        /// <summary>Slider position — intent. Feeds the exposure-facing corruption score.</summary>
        public readonly int ExportPercentage;
        /// <summary>Realized share of the city's dispatchable output sold. Feeds mobilization.</summary>
        public readonly int ExportLoadPercent;
        ...
        public readonly bool HasDraftExemption;
        public readonly int DraftDeferralPercent;
        ...
        public static CorruptionStateInputSnapshot Empty { get; } = new(
            hasShadowExport: false, exportPercentage: 0, exportLoadPercent: 0,
            ...
            hasDraftExemption: false, draftDeferralPercent: 0,
        ...
        public bool Equals(CorruptionStateInputSnapshot other)
            => HasShadowExport == other.HasShadowExport
               ...
               && ExportLoadPercent == other.ExportLoadPercent
               ...
               && HasDraftExemption == other.HasDraftExemption
               && DraftDeferralPercent == other.DraftDeferralPercent
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                ...
                hash = (hash * HashMultiplier) + ExportLoadPercent;
                ...
                hash = (hash * HashMultiplier) + HasDraftExemption.GetHashCode();
                hash = (hash * HashMultiplier) + DraftDeferralPercent;
    ...
    internal sealed class CorruptionStateInputSnapshotPublisher
    {
        public void Publish(
            ...
            EntityQuery draftExemptionQuery,
            ...
            IDistrictStateReader? districtState)
        {
            ...
            bool hasDraftExemption = draftExemptionQuery.TryGetSingleton<DraftExemptionSingleton>(out var draftExemption);
            ...
            view.Publish(new CorruptionStateInputSnapshot(
                ...
                hasShadowExport ? shadowExport.ExportLoadPercent : 0,
                hasShadowWallet,
                ...
                hasDraftExemption,
                hasDraftExemption ? draftExemption.RatePercent : 0,
                hasContractStats,
