    ...
    public class NarrativeSatireProvider : ISatireProvider
    {
        ...
        public IReadOnlyDictionary<string, SatireConfig> GetConfigs()
        {
            return new Dictionary<string, SatireConfig>
            {
                ...
                // ============================================
                // Narrative quests - start / resolve beats
                // ============================================
                ["SATIRE_QUEST_KOTLETA_START"] = new("SATIRE_QUEST_KOTLETA_START", 1, "KOTLETA", SocialMood.Suffering),
                ["SATIRE_QUEST_KOTLETA_DONE"] = new("SATIRE_QUEST_KOTLETA_DONE", 1, "KOTLETA", SocialMood.Smug),
                ["SATIRE_QUEST_KOTLETA_FAIL"] = new("SATIRE_QUEST_KOTLETA_FAIL", 1, "KOTLETA", SocialMood.Suffering),
                ["SATIRE_QUEST_VOICE_START"] = new("SATIRE_QUEST_VOICE_START", 1, "FREE_PRESS", SocialMood.Warning),
                ["SATIRE_QUEST_VOICE_DONE"] = new("SATIRE_QUEST_VOICE_DONE", 1, "FREE_PRESS", SocialMood.Neutral),
                ["SATIRE_QUEST_AIRDEFENSE_START"] = new("SATIRE_QUEST_AIRDEFENSE_START", 1, "VOLUNTEER", SocialMood.Warning),
                ["SATIRE_QUEST_AIRDEFENSE_DONE"] = new("SATIRE_QUEST_AIRDEFENSE_DONE", 1, "VOLUNTEER", SocialMood.Neutral),
                ["SATIRE_QUEST_AIRDEFENSE_FAIL"] = new("SATIRE_QUEST_AIRDEFENSE_FAIL", 1, "VOLUNTEER", SocialMood.Suffering),
                ["SATIRE_QUEST_AIRDEFENSE_ALREADY"] = new("SATIRE_QUEST_AIRDEFENSE_ALREADY", 1, "VOLUNTEER", SocialMood.Neutral),
