...
using CivicSurvival.Domains.Narrative.UI;
...
namespace CivicSurvival.Domains.Narrative
{
    ...
    public class NarrativeDomain : IFeatureModule, IContentFeatureModule, IDependentFeatureModule
    {
        ...
        public void RegisterSystems(UpdateSystem updateSystem)
        {
            ...
            // Narrative quests - event-driven objectives from story characters
            updateSystem.RegisterAt<QuestSystem>(SystemUpdatePhase.GameSimulation);
            updateSystem.RegisterAt<QuestUISystem>(SystemUpdatePhase.UIUpdate);
