        ...
        protected override void OnPanelUpdate()
        {
            PublishWhenComplete(AttentionState, NoSourceChecks, () =>
            {
                ...
                return new AttentionDto
                {
                    ...
                    KineticRatePercentPerDay = exodus.KineticRatePercentPerDay,
                    PsyRatePercentPerDay = exodus.PsyRatePercentPerDay,
                    TotalExodus = exodus.TotalExodus,
                    MonacoFamiliesFled = exodus.MonacoFamiliesFled,
                    MonacoCapitalFled = exodus.MonacoCapitalFled
                };
            });
        }
    }
