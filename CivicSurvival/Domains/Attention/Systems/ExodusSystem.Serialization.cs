    ...
    public partial class ExodusSystem : IDefaultSerializable, IBootDefaultsReset
    {
        ...
        public void Deserialize<TReader>(TReader reader) where TReader : IReader
        {
            ...
            try
            {
                ...
                // The damper's peak is no longer this system's to restore or report — it is the
                // city's single peak, owned by ScenarioStateMachine and printed on every exodus
                // day. A failed deserialize here can therefore no longer zero one of the city's
                // two peaks while the other survives.
                Log.Info($"Deserialized v{version}: TotalExodus={m_TotalExodusThisSession}, LastProcessedDay={m_DayDedup.LastProcessedDay}, LastAct={m_LastProcessedAct}, Monaco={m_MonacoFamiliesFled} families/${m_MonacoCapitalFled:N0}");
                UpdateSingleton();
            }
