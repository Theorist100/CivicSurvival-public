...
namespace CivicSurvival.Domains.Mobilization
{
    ...
    public class MobilizationDomain : IFeatureModule, IUiFeatureModule
    {
        ...
        public void RegisterSystems(UpdateSystem updateSystem)
        {
            ...
            // Player mobilization commands (conscription toggle / Call To Arms) run on
            // the pause-safe ModificationEnd route (Axiom 14) — no money, managed state,
            // applied synchronously.
            updateSystem.RegisterAt<MobilizationRequestIntakeSystem>(SystemUpdatePhase.ModificationEnd);
