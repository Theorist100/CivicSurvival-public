...
#pragma warning restore CIVIC487
        ...
        private void ApplyInterceptor(EntityCommandBuffer ecb, in InterceptorSpawnIntent intent)
        {
            ...
            ecb.SetComponent(entity, new Interceptor
            {
                ...
                // Boost climb: heading starts along the pitched-up launch rotation, and the movement
                // system's capped turn arcs it onto the chase course. Left at zero, the first tick
                // would snap the heading straight at the threat — a flat, horizon-level launch.
                CurrentDirection = math.forward(intent.Rotation),
                ...
                // First movement tick rewrites the full TransformFrame ring with a moving "emergence"
                // history — vanilla UpdateGroupSystem statics out the ring on the Created frame and the
                // missile would hang at the launcher for the interpolation delay otherwise.
                NeedsRingInit = true
            });
