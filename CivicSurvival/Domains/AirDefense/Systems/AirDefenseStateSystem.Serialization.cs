    ...
    public partial class AirDefenseStateSystem : IDefaultSerializable, IBootDefaultsReset
    {
        ...
        public void Serialize<TWriter>(TWriter writer) where TWriter : IWriter
        {
            ...
            try
            {
                ...
                var state = new AirDefenseCreditsPersistState(
                    ...
                    s.LastResupplyHourHawk,
                    s.LastResupplyWaveHawk);
        ...
        public void Deserialize<TReader>(TReader reader) where TReader : IReader
        {
            ...
            try
            {
                ...
                restored.LastResupplyHourHawk = state.LastResupplyHourHawk;
                restored.LastResupplyWaveHawk = state.LastResupplyWaveHawk;
                ...
                // A heritage grant buffered in the previous city must not credit the
                // loaded one — clear the in-process event buffer on the load leg too.
                ClearTransientState();
            }
