...
#pragma warning restore CIVIC229
        ...
        protected override void OnUpdateImpl()
        {
            ...
            // Gun rounds (Heritage/Bofors/Gepard) vs interceptor missiles (Patriot + Hawk), for
            // balance telemetry. Same per-type drain that already feeds the UI stats cache — this
            // only books the gun/missile split alongside the existing total.
            int missiles = shotsByType.Get(AAType.PatriotSAM) + shotsByType.Get(AAType.HawkSAM);
