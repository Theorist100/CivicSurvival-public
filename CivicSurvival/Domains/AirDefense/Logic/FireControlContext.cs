...
namespace CivicSurvival.Domains.AirDefense.Logic
{
    ...
    internal readonly struct FireControlContext
    {
        ...
        /// <summary>
        /// Wave leak regulator multiplier for this frame's intercept rolls, in
        /// [Waves.LeakRegulatorMinMultiplier, 1] — see <see cref="Core.Logic.LeakRegulatorLogic"/>.
        /// Below 1 the wave is killing more than its target share and chance is being pulled back;
        /// it never reaches 0, so no target is ever unkillable.
        /// </summary>
        public readonly float LeakSuppression;
            ...
            float leakSuppression)
        {
            ...
            LeakSuppression = leakSuppression;
        }
    }
