...
namespace CivicSurvival.Domains.AirDefense.Logic
{
    ...
    public readonly struct AirDefenseShotsByType
    {
        ...
        private readonly int m_Hawk;

        public AirDefenseShotsByType(int heritage, int bofors, int gepard, int patriot, int hawk)
        {
            m_Heritage = heritage;
            m_Bofors = bofors;
            m_Gepard = gepard;
        ...
        public int Total => m_Heritage + m_Bofors + m_Gepard + m_Patriot + m_Hawk;
...
#pragma warning restore CIVIC031
        ...
        public static AirDefenseShotsByType Drain()
        {
            ...
            int hawk = Interlocked.Exchange(ref s_AAShotsPending[(int)AAType.HawkSAM], 0);
            return new AirDefenseShotsByType(heritage, bofors, gepard, patriot, hawk);
        }
