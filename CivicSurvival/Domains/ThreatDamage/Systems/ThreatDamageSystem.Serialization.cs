...
namespace CivicSurvival.Domains.ThreatDamage.Systems
{
    public partial class ThreatDamageSystem : IDefaultSerializable, IResettable, IBootDefaultsReset
    {
        ...
        {
            // Clear per-frame containers. Shared
            ...
            // Fresh spatial-desync telemetry budget per session (ephemeral, [NonSerialized]) —
            // lives in the shared helper so every reset leg (fresh/load/boot) renews it.
