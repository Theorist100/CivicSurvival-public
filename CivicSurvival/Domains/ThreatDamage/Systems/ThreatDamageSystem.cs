...
namespace CivicSurvival.Domains.ThreatDamage.Systems
{
        ...
        ICivicSingletonOwner<ImpactPressureSingleton>
    {
        ...
        // Where a citizen actually IS, as opposed to which building lists them. Gates casualty
        // selection when Threats.CasualtyPresenceFilter is on — the same field vanilla's
        // CitizenEvacuateJob reads, and the one a shelter arrival rewrites, so sheltering survives
        // a strike on the citizen's home.
        ...
        protected override void OnCreate()
        {
            ...
            // Destroy/Ignite same-frame dedup moved to
        ...
        private void OnObservedActTransition(Act previous, Act current)
        {
            ...
            // Shared IFrameMutationDedup cleared every frame
        ...
        protected override void OnDestroy()
        {
            ...
            // Dispose same-frame tracking. Frame-mutation
        ...
        protected override void OnUpdateImpl()
        {
            ...
            using (Core.Utils.PerformanceProfiler.Measure("ThreatDamage.OnUpdate"))
            {
                ...
                // Shared IFrameMutationDedup frame-cleared
        ...
        private void ReportCasualties(Entity building, float3 position)
        {
            ...
            // Presence filter: only citizens whose CurrentBuilding IS this building die — a
            // resident at work, or one who reached a shelter after ThreatEvacuationSystem raised
            // danger here, survives a strike on their apartment. The assignment buffers list who
            // BELONGS to the building; CurrentBuilding is who is IN it.
            var presence = new CasualtyPresenceFilter(building, m_CurrentBuildingLookup);
