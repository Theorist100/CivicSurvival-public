...
namespace CivicSurvival.Core.Forecast
{
    ...
    public readonly struct LiveInputs
    {
        ...
        // ===== POPULATION =====
        /// <summary>
        /// True when the population owner answered — i.e. a city entity exists to ask. The value is
        /// how many people live there RIGHT NOW, which is a different question from the peak the
        /// sweep is handed separately: the peak says how big this city ever got, this says how big
        /// it is. The severity timeline needs the second one, because a pool recomputed from the
        /// peak keeps promising crews a bled-out city no longer has.
        /// </summary>
        public readonly bool PopulationLive;
        [PresenceGated(nameof(PopulationLive))] private readonly int m_Population;
        ...
        public LiveInputs(
            ...
            bool populationLive, int population)
        {
            PopulationLive = populationLive;
        ...
        /// <summary>Residents alive in the city right now; returns <see cref="PopulationLive"/>.</summary>
        public bool TryGetPopulation(out int population)
        {
            population = m_Population;
            return PopulationLive;
        }
