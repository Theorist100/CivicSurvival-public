...
namespace CivicSurvival.Core.Forecast
{
    ...
    {
        /// <summary>Phase (Alert / Attack / PsyAttack / Recovery) duration at the wave number, frequency
        /// mod and the given random midpoint (0.5 = the Min+Max midpoint the deterministic modes read).</summary>
