namespace CivicSurvival.Core.Types
{
    ...
    public enum ToastType
    {
        ...
        /// <summary>A wealthy family offers Shadow Cash for a fake disability exemption from the draft.</summary>
        DraftExemptionOffer,

        /// <summary>A story character calls with a quest proposal — accept arms the quest,
        /// decline or letting it ring out defers it to a cooldown. Non-corruption offer:
        /// no Trust header, outside the bribe pacing.</summary>
        QuestOffer
    }
