namespace CivicSurvival.Core.Types
{
    ...
    public static class EffectNames
    {
        ...
        /// <summary>Lighter moving fire — vanilla small fire, a smaller/dimmer plume than
        /// <see cref="FIRE_MOVING_MEDIUM_VFX"/>. Used for the Hawk interceptor's exhaust: a
        /// solid-rocket SAM leaves a thinner trail than the Patriot's, so it reads with less
        /// smoke. Owner-attached the same way.</summary>
        public const string FIRE_MOVING_SMALL_VFX = "FireSmallVFX";
    }
}
