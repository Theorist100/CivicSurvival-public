namespace CivicSurvival.Core.Types
{
    ...
    public readonly struct ManpowerBreakdown
    {
        ...
        /// <summary>Aggregate corruption the city can see (0-100) — what drives PatriotismFactor.
        /// Carried so diagnostics can tell "the city is clean" apart from "the aggregate is not
        /// being computed at all", which look identical from the resulting pool size.</summary>
        public readonly float VisibleCorruptionScore;

        /// <summary>Realized share of dispatchable output being sold covertly (0-100) — the input
        /// that feeds the export term of <see cref="VisibleCorruptionScore"/>.</summary>
        public readonly int ExportLoadPercent;

        /// <summary>True when the heritage-crew floor had to lift the pool, i.e. the city would
        /// otherwise have been unable to man the guns it was given for free.</summary>
        public readonly bool IsDefenceFloorEngaged;
        ...
        public ManpowerBreakdown(
            ...
            float visibleCorruptionScore, int exportLoadPercent, bool isDefenceFloorEngaged)
        {
            VisibleCorruptionScore = visibleCorruptionScore;
            ExportLoadPercent = exportLoadPercent;
            IsDefenceFloorEngaged = isDefenceFloorEngaged;
