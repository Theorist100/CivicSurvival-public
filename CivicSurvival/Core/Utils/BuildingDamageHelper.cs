...
namespace CivicSurvival.Core.Utils
{
    ...
    public static class BuildingDamageHelper
    {
        ...
        /// <summary>
        /// Full building transform read (position + rotation) behind the render ticket, for
        /// main-thread consumers without a lookup (e.g. placement handlers).
        /// </summary>
        public static bool TryGetBuildingTransform(
            ...
            out Transform transform)
        {
            ...
            {
                transform = entityManager.GetComponentData<Transform>(building);
                return true;
            }
