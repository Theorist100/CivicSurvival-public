...
namespace CivicSurvival.Core.Serialization
{
    ...
    public static class DemandPeakCodec
    {
        ...
        /// <summary>Absolute game-hour timestamps: NaN/Inf/negative-guard only, no upper cap —
        /// a timestamp is not a duration; an arbitrary ceiling would collapse a legitimate
        /// late-game value to default 0 (shared convention with
        /// <see cref="BuckwheatCodec.MaxSerializedTotalGameHours"/>).</summary>
        public const double MaxSerializedTotalGameHours = double.MaxValue;
