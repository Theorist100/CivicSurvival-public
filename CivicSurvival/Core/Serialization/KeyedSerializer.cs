...
#pragma warning restore CIVIC144
        ...
        // ════════════════════════════════════════════════════════════
        // Persisted district identity: see DistrictKeyCodec (engine entity remap).
        // The former raw-int WriteDistrictKey/ReadDistrictKey contract was removed —
        // a raw index does not survive load (slot reassigned on deserialize).
        // ════════════════════════════════════════════════════════════
