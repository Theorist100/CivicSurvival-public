...
namespace CivicSurvival.Core.Serialization
{
    public readonly struct DistrictPenaltyState
    {
        public DistrictPenaltyState(
            ...
            bool airDefenseDrilled)
        {
            AirDefenseDrilled = airDefenseDrilled;
        ...
        /// <summary>Air-defense drill bonus active (expires at wave 2, not on a clock).</summary>
        public bool AirDefenseDrilled { get; }
    }
    ...
    public static class DistrictPenaltyCodec
    {
            ...
            where TWriter : IWriter
        {
            ...
            KeyedSerializer.WriteField(writer, "airDefenseDrilled", state.AirDefenseDrilled);
        }
            ...
            for (int i = 0; i < fieldCount; i++)
            {
                ...
                switch (key)
                {
                    ...
                    case "preWarPenalty":
                        ...
                        break;
                    case "airDefenseDrilled":
                        airDefenseDrilled = KeyedSerializer.ReadBool(reader, tag, "airDefenseDrilled");
                        break;
                    default:
