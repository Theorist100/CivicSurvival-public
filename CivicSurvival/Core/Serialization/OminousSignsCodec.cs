...
namespace CivicSurvival.Core.Serialization
{
    public readonly struct OminousSignsPersistState
    {
        public OminousSignsPersistState(
            ...
            bool warStarted,
            bool belowTownBoundaryNoticeShown)
        {
            Active = active;
            SignsTriggered = signsTriggered;
            WarStarted = warStarted;
            BelowTownBoundaryNoticeShown = belowTownBoundaryNoticeShown;
        }

        public bool Active { get; }
        public OminousSignFlags SignsTriggered { get; }
        public bool WarStarted { get; }
        public bool BelowTownBoundaryNoticeShown { get; }
    }
    ...
    public static class OminousSignsCodec
    {
            ...
            where TWriter : IWriter
        {
            ...
            KeyedSerializer.WriteField(writer, "m_BelowTownBoundaryNoticeShown", state.BelowTownBoundaryNoticeShown);
        }
            ...
            where TReader : IReader
        {
            ...
            bool belowTownBoundaryNoticeShown = false;
            ...
            for (int i = 0; i < fieldCount; i++)
            {
                ...
                switch (key)
                {
                    ...
                    case "m_WarStarted":
                        ...
                        break;
                    case "m_BelowTownBoundaryNoticeShown":
                        belowTownBoundaryNoticeShown = KeyedSerializer.ReadBool(reader, tag, "m_BelowTownBoundaryNoticeShown");
                        break;
                    default:
