...
namespace CivicSurvival.Core.Serialization
{
    public readonly struct WaveSchedulerPersistState
    {
        ...
        public bool HasNextWaveForecast { get; }
    ...
    public static class WaveSchedulerCodec
    {
            ...
            where TWriter : IWriter
        {
            ...
            KeyedSerializer.WriteField(writer, "hasNextForecast", state.HasNextWaveForecast);
            ...
            where TReader : IReader
        {
            ...
            var nextWaveType = WaveType.Harassment;
            int nextWaveThreatsForecast = 0;
            bool hasNextWaveForecast = false;
            uint randomState = 0;
            ...
            for (int i = 0; i < fieldCount; i++)
            {
                ...
                switch (key)
                {
                    ...
                    case "nextWaveType": nextWaveType = KeyedSerializer.ReadEnumByte<TReader, WaveType>(reader, tag, "nextWaveType", WaveType.Harassment); break;
                    case "nextThreatsForecast": nextWaveThreatsForecast = KeyedSerializer.ReadClampedInt(reader, tag, "nextThreatsForecast", 0, 1000); break;
                    case "hasNextForecast": hasNextWaveForecast = KeyedSerializer.ReadBool(reader, tag, "hasNextForecast"); break;
                    case "randomState":
