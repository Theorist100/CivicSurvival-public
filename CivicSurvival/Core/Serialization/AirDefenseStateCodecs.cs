...
namespace CivicSurvival.Core.Serialization
{
    ...
    public readonly struct AirDefenseCreditsPersistState
    {
        public AirDefenseCreditsPersistState(
            ...
            float lastResupplyHourHawk,
            int lastResupplyWaveHawk)
        {
            ...
            LastResupplyHourHawk = SanitizeHour(lastResupplyHourHawk);
            LastResupplyWaveHawk = SanitizeWave(lastResupplyWaveHawk);
        }
        ...
        public float LastResupplyHourHawk { get; }
        public int LastResupplyWaveHawk { get; }
    ...
    public static class AirDefenseCreditsCodec
    {
            ...
            where TWriter : IWriter
        {
            ...
            KeyedSerializer.WriteField(writer, "rsK", state.LastResupplyHourHawk);
            KeyedSerializer.WriteField(writer, "rwK", state.LastResupplyWaveHawk);
        }
            ...
            where TReader : IReader
        {
            ...
            // Hawk missile resupply gate — same legacy-safe defaults as the Patriot.
            float lastResupplyHourHawk = -1f;
            int lastResupplyWaveHawk = -1;
            ...
            for (int i = 0; i < fieldCount; i++)
            {
                ...
                switch (key)
                {
                    ...
                    case "rwP":
                        ...
                        break;
                    case "rsK":
                        lastResupplyHourHawk = KeyedSerializer.ReadFloat(reader, tag, "rsK", -1f);
                        break;
                    case "rwK":
                        lastResupplyWaveHawk = KeyedSerializer.ReadBoundedInt(reader, tag, "rwK", -1, 100000, -1);
                        break;
                    default:
                        KeyedSerializer.Skip(reader, tag);
                        break;
            ...
            state = new AirDefenseCreditsPersistState(
                ...
                lastResupplyHourHawk,
                lastResupplyWaveHawk);
        }
    }
