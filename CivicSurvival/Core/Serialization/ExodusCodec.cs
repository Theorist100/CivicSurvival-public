...
namespace CivicSurvival.Core.Serialization
{
    ...
    public static class ExodusCodec
    {
        ...
        {
            // 11 fields before the two peaks of one city were merged into the scenario one.
            // The "peakPop" key is no longer written; a save that still has it hits the
            // reader's default branch and is skipped, which is how this format drops a field.
