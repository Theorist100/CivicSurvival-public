...
namespace CivicSurvival.Core.UI
{
    ...
    internal static class RequestResultBridge
    {
        ...
        public const string PropagandaCenterPlacement = "PropagandaCenterPlacementRequest";
        public const string PropagandaCenterUpgrade = "PropagandaCenterUpgradeRequest";
        ...
        public const string DroneLauncherPlacement = "DroneLauncherPlacementRequest";
        public const string BallisticLauncherPlacement = "BallisticLauncherPlacementRequest";
        ...
        internal static void RejectNew(
            string key,
            string reasonId,
            string discriminatorKind = "none",
            string discriminatorValue = "")
        {
            // The discriminator must ride on rejections exactly like on successes:
            // discriminator-scoped consumers (requestResultForTarget) never match a
            // bare rejection and hang isPending forever.
            var token = Begin(key, discriminatorKind, discriminatorValue);
