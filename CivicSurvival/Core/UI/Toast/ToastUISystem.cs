...
#pragma warning disable CA1001
    [ActIndependent]
    public partial class ToastUISystem : CivicUIPanelSystem, IGameplayReadyListener, IGameplayEndedListener
#pragma warning restore CA1001
    {
        ...
        /// <summary>
        /// A toast belongs to the city that raised it, so both session boundaries empty the
        /// queue — and both are needed, because neither covers the other. Exiting to the main
        /// menu raises GameplayEnded; loading a save straight over a running city skips the
        /// menu entirely and never raises it (CivicGameLifecycle.MarkReloadPending). Clearing
        /// on entry too means every city starts with an empty queue however it was reached,
        /// and the panel — which stays alive in the menu (RequiresLoadedGame = false) — has
        /// nothing left over to draw there.
        /// </summary>
        public void OnGameplayReady() => m_Service.ClearSessionState();

        public void OnGameplayEnded() => m_Service.ClearSessionState();
