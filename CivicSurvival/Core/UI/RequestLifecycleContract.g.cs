    ...
    internal static class RequestLifecycleContract
    {
        internal static string KeyForKind(RequestKind kind)
        {
            switch (kind)
            {
                ...
                case RequestKind.PropagandaCenterPlacement: return "PropagandaCenterPlacementRequest";
                case RequestKind.DroneLauncherPlacement: return "DroneLauncherPlacementRequest";
                case RequestKind.BallisticLauncherPlacement: return "BallisticLauncherPlacementRequest";
                ...
                case RequestKind.PropagandaCenterUpgrade: return "PropagandaCenterUpgradeRequest";
        ...
        internal static RequestKind KindForKey(string key)
        {
            switch (key)
            {
                ...
                case "PropagandaCenterPlacementRequest": return RequestKind.PropagandaCenterPlacement;
                case "DroneLauncherPlacementRequest": return RequestKind.DroneLauncherPlacement;
                case "BallisticLauncherPlacementRequest": return RequestKind.BallisticLauncherPlacement;
                ...
                case "PropagandaCenterUpgradeRequest": return RequestKind.PropagandaCenterUpgrade;
        ...
        internal static RequestResultMode ResultModeForKind(RequestKind kind)
        {
            switch (kind)
            {
                ...
                case RequestKind.PropagandaCenterPlacement: return RequestResultMode.Simple;
                case RequestKind.DroneLauncherPlacement: return RequestResultMode.Simple;
                case RequestKind.BallisticLauncherPlacement: return RequestResultMode.Simple;
                ...
                case RequestKind.PropagandaCenterUpgrade: return RequestResultMode.Simple;
        ...
        internal static RequestResultDiscriminator DiscriminatorForKind(RequestKind kind)
        {
            switch (kind)
            {
                ...
                case RequestKind.PropagandaCenterPlacement: return RequestResultDiscriminator.None;
                case RequestKind.DroneLauncherPlacement: return RequestResultDiscriminator.None;
                case RequestKind.BallisticLauncherPlacement: return RequestResultDiscriminator.None;
                ...
                case RequestKind.PropagandaCenterUpgrade: return RequestResultDiscriminator.None;
