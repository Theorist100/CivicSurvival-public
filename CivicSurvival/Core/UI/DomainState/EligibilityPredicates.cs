...
namespace CivicSurvival.Core.UI.DomainState
{
    ...
    public static class AirDefenseEligibility
    {
        ...
        /// </summary>
        public static bool CanPlaceShadowAA(int price, int availableManpower, int crewRequired,
        ...
        public static int AffordableShadowAACount(int price, int availableManpower, int crewRequired,
        ...
        public static bool CanPlaceCreditAA(int credits, int availableManpower, int crewRequired, out string reasonId)
        {
            if (credits <= 0)
            {
