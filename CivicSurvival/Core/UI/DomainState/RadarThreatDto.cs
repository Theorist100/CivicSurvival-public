namespace CivicSurvival.Core.UI.DomainState
{
    ...
    public partial struct RadarThreatDto
    {
        ...
        // True for the player's outbound counter-strike track (PlayerOutboundThreat enabled).
        // Lets the radar draw an allied track/marker instead of an enemy one, and keeps outbound
        // out of the inbound-threat counters.
