...
namespace CivicSurvival.Core.UI.DomainState
{
    ...
    public partial struct GridWarfareDto : IDomainDto
    {
        ...
        // Same pair for the ballistic emplacement: live BallisticLauncherInstallation count gates
        // the ballistic strike (0 = no launch origin, the round cannot fire) and the pre-markup
        // GridWarfare.BallisticLauncherCost drives its build card.
        public int BallisticLauncherCount;
        public int BallisticLauncherCost;
        ...
        // Same lifecycle for the "build ballistic launcher" tool.
        public string BallisticLauncherPlacementRequestJson;
