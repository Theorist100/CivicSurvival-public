...
namespace CivicSurvival.Core.UI.DomainState
{
    internal static class DomainDtoWriters
    {
        ...
        internal static void WriteQuestEntryDtoSegment0(ref DomainJsonHelper.JsonWriter w, in QuestEntryDto dto)
        {
            w.Int("Id", dto.Id);
            w.Int("Phase", dto.Phase);
            w.Int("Progress", dto.Progress);
            w.Int("Target", dto.Target);
            w.Double("HoursLeft", dto.HoursLeft);
            w.Int("Anchor", dto.Anchor);
        }
        ...
        internal static void WriteToastDataDtoSegment0(ref DomainJsonHelper.JsonWriter w, in ToastDataDto dto)
        {
            ...
            w.Bool("HasActions", dto.HasActions);
        }
        ...
        internal static void WriteQuestDtoSegment0(ref DomainJsonHelper.JsonWriter w, in QuestDto dto)
        {
            w.Raw("Quests", dto.QuestsJson ?? "[]");
        }

        internal static void WriteQuestResultModalPayloadDtoSegment0(ref DomainJsonHelper.JsonWriter w, in QuestResultModalPayloadDto dto)
        {
            w.Int("Id", dto.Id);
            w.Int("Progress", dto.Progress);
            w.Int("Target", dto.Target);
        ...
        internal static void WriteGridWarfareDtoSegment0(ref DomainJsonHelper.JsonWriter w, in GridWarfareDto dto)
        {
            ...
            w.Int("BallisticLauncherCount", dto.BallisticLauncherCount);
            w.Int("BallisticLauncherCost", dto.BallisticLauncherCost);
        ...
        internal static void WriteGridWarfareDtoSegment1(ref DomainJsonHelper.JsonWriter w, in GridWarfareDto dto)
        {
            ...
            w.Raw("BallisticLauncherPlacementRequest", dto.BallisticLauncherPlacementRequestJson ?? RequestResultBridge.Get(RequestResultBridge.BallisticLauncherPlacement).ToJson());
        ...
        {
            w.Bool("IsManpowerMeasured", dto.IsManpowerMeasured);
            w.Int("ManpowerAvailable", dto.ManpowerAvailable);
            w.Int("ManpowerUsed", dto.ManpowerUsed);
            w.Int("ManpowerTotal", dto.ManpowerTotal);
            ...
            w.Int("ManpowerCorruptionScore", dto.ManpowerCorruptionScore);
        ...
        internal static void WriteThreatDtoSegment0(ref DomainJsonHelper.JsonWriter w, in ThreatDto dto)
        {
            ...
            w.Int("DebriefingEvacSheltered", dto.DebriefingEvacSheltered);
            w.Int("DebriefingEvacEnRoute", dto.DebriefingEvacEnRoute);
    ...
    public partial struct QuestEntryDto
    {
        ...
        {
            var w = new DomainJsonHelper.JsonWriter(sb);
            DomainDtoWriters.WriteQuestEntryDtoSegment0(ref w, this);
            w.End();
        }
    }
    ...
    public partial struct QuestDto
    {
        public void WriteTo(StringBuilder sb)
        {
            var w = new DomainJsonHelper.JsonWriter(sb);
            DomainDtoWriters.WriteQuestDtoSegment0(ref w, this);
            w.End();
        }
    }

    public partial struct QuestResultModalPayloadDto
    {
        public void WriteTo(StringBuilder sb)
        {
            var w = new DomainJsonHelper.JsonWriter(sb);
            DomainDtoWriters.WriteQuestResultModalPayloadDtoSegment0(ref w, this);
            w.End();
        }
    }
