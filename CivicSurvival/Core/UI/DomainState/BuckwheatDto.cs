...
namespace CivicSurvival.Core.UI.DomainState
{
    public partial struct BuckwheatDto : IDomainDto // buckwheat districts are serialized as buckwheatDistricts.
    {
        ...
        /// <summary>True when the ShadowEconomy feature is live and the offshore shadow
        /// wallet is available to fund procurement. Buckwheat is always shadow-funded;
        /// this flags whether that funding source is currently reachable. Mirrors
        /// BuckwheatEligibility.ShadowFundingLive.</summary>
        public bool ShadowFunded;
