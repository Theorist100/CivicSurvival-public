namespace CivicSurvival.Core.UI.DomainState
{
    ...
    public partial struct ToastDataDto
    {
        ...
        // Offer/Notice discriminator: true = corruption-style offer with Accept/Decline
        // buttons (and the Trust header it justifies), false = neutral notice — title,
        // message, dismiss and auto-expiry only.
