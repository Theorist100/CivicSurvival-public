...
namespace CivicSurvival.Core.UI.DomainState
{
    ...
    public partial struct ThreatDto : IDomainDto
    {
        ...
        public string RadarBroadcastsJson;
        ...
        public int DebriefingEvacSheltered;
        /// <summary>Citizens still running for a shelter at wave end (turned around at all-clear).</summary>
        public int DebriefingEvacEnRoute;
