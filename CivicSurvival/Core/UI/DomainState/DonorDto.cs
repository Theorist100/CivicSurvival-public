...
namespace CivicSurvival.Core.UI.DomainState
{
    ...
    public partial struct DonorDto : IDomainDto
    {
        ...
        /// <summary>
        /// Phase 15: true when the conference is available specifically because world
        /// attention (WorldShock) opened the gate and the domestic blackout-% crisis did
        /// not — lets the panel surface "aid available on world attention." Shock level and
        /// tier themselves are already carried by <c>AttentionDto</c> (surfaced in the same
        /// panel), so only this path signal is added here rather than duplicating them.
        /// </summary>
        public bool AvailableViaAttention;
