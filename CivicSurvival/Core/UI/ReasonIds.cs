...
namespace CivicSurvival.Core.Types
{
    ...
    public static partial class ReasonIds
    {
        ...
        [UiReasonId("aa insufficient shadow funds")]
        public static readonly ReasonId AaInsufficientShadowFunds = ReasonId.Of("UI_AA_INSUFFICIENT_SHADOW_FUNDS");

        [UiReasonId("aa shadow wallet frozen")]
        public static readonly ReasonId AaShadowWalletFrozen = ReasonId.Of("UI_AA_SHADOW_WALLET_FROZEN");
        ...
        [UiReasonId("propaganda center placement cancelled")]
        public static readonly ReasonId CenterCancelled = ReasonId.Of("UI_CENTER_CANCELLED");

        [UiReasonId("propaganda center placement failed")]
        public static readonly ReasonId CenterPlacementFailed = ReasonId.Of("UI_CENTER_PLACEMENT_FAILED");

        [UiReasonId("propaganda center budget payment failed")]
        public static readonly ReasonId CenterBudgetFailed = ReasonId.Of("UI_CENTER_BUDGET_FAILED");

        [UiReasonId("propaganda center placement building lost")]
        public static readonly ReasonId CenterBuildingLost = ReasonId.Of("UI_CENTER_BUILDING_LOST");

        [UiReasonId("propaganda center already built")]
        public static readonly ReasonId CenterAlreadyBuilt = ReasonId.Of("UI_CENTER_ALREADY_BUILT");

        [UiReasonId("propaganda center required")]
        public static readonly ReasonId CenterRequired = ReasonId.Of("UI_CENTER_REQUIRED");

        [UiReasonId("propaganda center at max upgrade tier")]
        public static readonly ReasonId CenterMaxTier = ReasonId.Of("UI_CENTER_MAX_TIER");

        [UiReasonId("propaganda center system unavailable")]
        public static readonly ReasonId CenterUnavailable = ReasonId.Of("UI_CENTER_UNAVAILABLE");
        ...
        // Typed per munition (ArsenalKindMap): the generic "procure drones or rockets"
        // text sent a player buying 20 drones for a disinfo op that flies on a rocket.
        [UiReasonId("gw no arsenal drone")]
        public static readonly ReasonId GwNoArsenalDrone = ReasonId.Of("UI_GW_NO_ARSENAL_DRONE");

        [UiReasonId("gw no arsenal ballistic")]
        public static readonly ReasonId GwNoArsenalBallistic = ReasonId.Of("UI_GW_NO_ARSENAL_BALLISTIC");
        ...
        [UiReasonId("drone launcher placement cancelled")]
        public static readonly ReasonId DroneLauncherCancelled = ReasonId.Of("UI_DRONE_LAUNCHER_CANCELLED");

        [UiReasonId("drone launcher placement failed")]
        public static readonly ReasonId DroneLauncherPlacementFailed = ReasonId.Of("UI_DRONE_LAUNCHER_PLACEMENT_FAILED");

        [UiReasonId("drone launcher insufficient shadow funds")]
        public static readonly ReasonId DroneLauncherInsufficientShadowFunds = ReasonId.Of("UI_DRONE_LAUNCHER_INSUFFICIENT_SHADOW_FUNDS");

        [UiReasonId("drone launcher placement building lost")]
        public static readonly ReasonId DroneLauncherBuildingLost = ReasonId.Of("UI_DRONE_LAUNCHER_BUILDING_LOST");

        [UiReasonId("ballistic launcher placement cancelled")]
        public static readonly ReasonId BallisticLauncherCancelled = ReasonId.Of("UI_BALLISTIC_LAUNCHER_CANCELLED");

        [UiReasonId("ballistic launcher placement failed")]
        public static readonly ReasonId BallisticLauncherPlacementFailed = ReasonId.Of("UI_BALLISTIC_LAUNCHER_PLACEMENT_FAILED");

        [UiReasonId("ballistic launcher insufficient shadow funds")]
        public static readonly ReasonId BallisticLauncherInsufficientShadowFunds = ReasonId.Of("UI_BALLISTIC_LAUNCHER_INSUFFICIENT_SHADOW_FUNDS");

        [UiReasonId("ballistic launcher placement building lost")]
        public static readonly ReasonId BallisticLauncherBuildingLost = ReasonId.Of("UI_BALLISTIC_LAUNCHER_BUILDING_LOST");
        ...
        [UiReasonId("hero archetype switch on cooldown")]
        public static readonly ReasonId HeroSwitchCooldown = ReasonId.Of("UI_HERO_SWITCH_COOLDOWN");
        ...
        [UiReasonId("settings nickname needs online")]
        public static readonly ReasonId SettingsNicknameNeedsOnline = ReasonId.Of("UI_SETTINGS_NICKNAME_NEEDS_ONLINE");
        ...
        [UiReasonId("settings report rate limited")]
        public static readonly ReasonId SettingsStatusReportRateLimited = ReasonId.Of("UI_SETTINGS_STATUS_REPORT_RATE_LIMITED");
