...
namespace CivicSurvival.Core.Interfaces.Services
{
    ...
    [OwnedByFeatureId(FeatureIds.CorruptionName)]
    public interface IDraftExemptionSettingsWriter
    {
        bool TrySetDraftDeferralPercent(int percent);
    }

    [OwnedByFeatureId(FeatureIds.CorruptionName)]
    public interface IConstructionKickbackSettingsWriter
    {
        bool TrySetConstructionKickbackPercent(int percent);
    }
}
