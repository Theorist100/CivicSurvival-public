...
namespace CivicSurvival.Core.Interfaces
{
    ...
    /// <c>BuildingPlacementIntent</c> doctrine (the realized vanilla Temp/ToolApplySystem
    ...
    /// analyzer reads. <c>BuildingPlacementIntent</c> is annotated first because it
