...
namespace CivicSurvival.Core.Components.Threats
{
    ...
    ///
    /// Written by: AABuildingPlacementHandler.Commit (via BuildingPlacementCommitSystem, creates separate entity)
    ...
    public struct AirDefenseInstallation : IComponentData, ISerializable, IBuildingLinked
    {
        ...
        /// <summary>Budget actually charged at placement (BuildingPlacementIntent.Cost when
    ...
    public struct RadarThreatBuffer : IBufferElementData
    {
        ...
        /// <summary>True when this track is the player's outbound counter-strike
        /// (PlayerOutboundThreat bit enabled), false for an inbound wave threat. Drives the
        /// radar's allied-vs-enemy styling; inbound stays the default enemy look.</summary>
    ...
    ///
    /// Written by: AABuildingPlacementHandler.Commit, HeritageGrantSystem (AirDefense domain)
