...
namespace CivicSurvival.Core.Components.Threats
{
    ...
    public struct ShahedCombatState : IComponentData, ISerializable
    {
        ...
        /// coordinated strike saturates point defense: it is harder to intercept
        /// (Waves.FocusInterceptMultiplier) but never immune.
        /// </summary>
        ...
        /// only; guns leave it false → instant freeze + explode as before. Render-only deferral —
        /// PvP-safe (kill decided in the firing frame by the formula).
        /// </summary>
