namespace CivicSurvival.Core.Components.Domain.AirDefense
{
    ...
    {
        /// <summary>Total live installations = Heritage + Bofors + Gepard + Patriot + Hawk.</summary>
        ...
        public readonly int HawkCount;

        public AirDefenseFleetView(int heritageCount, int boforsCount, int gepardCount, int patriotCount, int hawkCount)
        {
            ...
            HawkCount = hawkCount;
            TotalAa = heritageCount + boforsCount + gepardCount + patriotCount + hawkCount;
        }
    }
}
