...
namespace CivicSurvival.Core.Components.Domain.GridWarfare
{
    ...
    /// ballistic. The exact distribution is a balance concern — this is the
    ...
    /// ballistic rockets. One unit is spent per launch and replenished
    /// through two channels: shadow import / donors (fast, paid) and
