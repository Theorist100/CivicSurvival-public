...
namespace CivicSurvival.Core.Components.Domain.Power
{
    ...
    /// (consumer) and the mod's own <c>ModFireIntent</c> / <c>BuildingPlacementIntent</c> pattern.
    ...
    /// pause-ticking phase.
    ///
    /// Serializable, like <c>ModFireIntent</c> / <c>BuildingPlacementIntent</c>: a save taken in
