...
namespace CivicSurvival.Core.Components.Domain.Cognitive
{
    ...
    public struct IPSOState : IComponentData
    {
        ...
        /// <summary>Number of districts where enemy network propaganda amplifies above the
        /// word-of-mouth floor (for UI). See IPSOCampaignSystem.AFFECTED_THRESHOLD.</summary>
...
#pragma warning disable CIVIC262 // Session-local runtime district key; NOT persisted (IPSODistrictExposureBuffer has no engine serializer and is rebuilt every tick from CognitiveIntegrityBuffer)
