...
namespace CivicSurvival.Core.Logic
{
    ...
    public static class ManpowerLogic
    {
            ...
            bool isConscription)
        {
            ...
            return Math.Max(0, rawTotal - casualties - deferralHeads - Math.Max(0, disabilityHeads));
        }
            ...
            bool isConscription)
        {
            ...
            // Casualties and sold exemptions reduce effective manpower cap
            int total = rawTotal - casualties - deferralHeads - clampedDisability;
            if (total < 0) total = 0;
