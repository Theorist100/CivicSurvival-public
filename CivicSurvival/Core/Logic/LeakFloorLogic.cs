...
namespace CivicSurvival.Core.Logic
{
    ...
    /// <c>InterceptProcessingSystem.ShouldLeak</c> so the in-game crisis-sweep severity
    /// can predict the guaranteed drone breach-through with the same code the runtime
