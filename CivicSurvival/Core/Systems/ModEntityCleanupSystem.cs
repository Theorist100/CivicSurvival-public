    ...
    public partial class ModEntityCleanupSystem : CivicSystemBase, IPostLoadValidation
    {
        ...
        protected override void OnUpdateImpl()
        {
            ...
            using (PerformanceProfiler.Measure("MECS.CleanupPass"))
            {
                ...
                {
                    case 0:
                        using (PerformanceProfiler.Measure("MECS.Batch0"))
                        {
                    ...
                    case 1:
                        using (PerformanceProfiler.Measure("MECS.Batch1"))
                        {
                    ...
                    case 2:
                        using (PerformanceProfiler.Measure("MECS.Batch2"))
                        {
                    ...
                    default:
                        using (PerformanceProfiler.Measure("MECS.Batch3"))
                        {
