...
#pragma warning disable CIVIC112
                ...
                // Isolated probe (temporary, see PSY_SCAN_EXTRACTION_PLAN.md): what the fence
                // costs after the split — expected ~sub-ms, scan work plus Deleted writers only.
                using (PerformanceProfiler.Measure("SP:PsyScan.Complete"))
                    scanHandle.Complete();
